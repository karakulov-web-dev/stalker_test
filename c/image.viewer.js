(function() {
  function ImageViewerConstructor() {
    ...
    this.update_label = function() {
      ...
      this.label_obj.innerHTML =
        this.image_list[this.cur_idx].name +
        " (" +
        this.convert_bytes(this.image_list[this.cur_idx].size) +
        ")" +
        " [" +
        (this.cur_idx + 1) +
        "/" +
    ...
    this.t_hide_label = function() {
      ...
      this.hide_label_timeout = window.setTimeout(function() {
        self.label_obj.hide();
      }, 5000);
    };
