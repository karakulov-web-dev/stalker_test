...
this.update_channels = function(){
  _debug('kvant_app.update_channels');
      ...
      setTimeout("document.getElementById('kvant_loading').style.display = 'none'; document.getElementById('kvant_select_channel').style.display = 'block'; document.getElementById('kvant_menu').style.display = 'block';", 1500);
