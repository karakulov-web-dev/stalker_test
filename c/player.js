...
player.prototype.volume = new function(){
    ...
    this._get_real_volume_level = function(level){
        ...
        if ((stb.profile['logarithm_volume_control'])&&(stb.mac.substring(0,8)!="10:27:BE")){
...
player.prototype.init_con_menu = function(){
      ...
      var TempMap =  
    {
        ...
        "cmd"   : [ 
            {
                "cmd"   : function(){stb.player.TempOnVideo.changeType('Off');},
                "title" : "Откл.",
                "active": (stb.player.TempOnVideo.position == "Off")
            },
            {
                "cmd"   : function(){stb.player.TempOnVideo.changeType('upRight');},
                "title" : "Сверху справа",
                "active": (stb.player.TempOnVideo.position == "upRight")
            },
            {
                "cmd"   : function(){stb.player.TempOnVideo.changeType('upLeft');},
                "title" : "Сверху слева",
                "active": (stb.player.TempOnVideo.position == "upLeft")
            },
            {
                "cmd"   : function(){stb.player.TempOnVideo.changeType('downRight');},
                "title" : "Снизу справа",
                "active": (stb.player.TempOnVideo.position == "downRight")
            },
            {
                "cmd"   : function(){stb.player.TempOnVideo.changeType('downLeft');},
                "title" : "Снизу слева",
    ...
    var WeatherMap = 
            {
                "title" : "Погода",
                "cmd"   : [
            {    "cmd"   : function(){module.dayweather.show();},
                "title" : "Gismeteo"
            }
            ]        
    };
...
player.prototype.TempOnVideo = {
    ...
    changeType : function(value){
        ...
        this.position = value;
        setTimeout("stb.RDir('setenv temp_on_player '+ player.prototype.TempOnVideo.position);",1000);
