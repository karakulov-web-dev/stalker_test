(function() {
    function kino_kuzbass_constructor() {
        ...
        this.trailer_url = "http://212.77.128.203/apps/kinoteatr/video/";
        this.today;
        this.today_save;
        this.shedule;
        this.kino_active;
        ...
        this.show = function() {
            ...
            src =
                ...
                resolution_prefix +
                "/mb_scroll.png";
            document.getElementById("scrol_now").innerHTML =
                '<img src="' + src + '">';
        ...
        this.today_update = function(pozition) {
            ...
            if (kino_kuzbass.today.length > 0) {
                ...
                if (resolution_prefix == "_720") {
                    ...
                    img_url =
                        "http://kuzbass.mezhdu.net/datas/users/img.php?img=" +
                        kino_kuzbass.today[pozition].big_logo.substr(
                            40,
                            kino_kuzbass.today[pozition].big_logo.length
                        );
                    document.getElementById("kino_img0").innerHTML =
                        '<img src="' + img_url + '">';
                } else {
                    document.getElementById("kino_img0").innerHTML =
                        '<img src="' + kino_kuzbass.today[pozition].logo + '">';
                }
                document.getElementById("name0").innerHTML =
                    kino_kuzbass.today[pozition].name;
                document.getElementById("genre0").innerHTML =
                    kino_kuzbass.today[pozition].genre;
                document.getElementById("kino_data0").innerHTML =
                    kino_kuzbass.today[pozition].date;
            } else {
            ...
            if (kino_kuzbass.today.length > 1) {
                ...
                if (resolution_prefix == "_720") {
                    img_url1 =
                        "http://kuzbass.mezhdu.net/datas/users/img.php?img=" +
                        kino_kuzbass.today[pozition + 1].big_logo.substr(
                            40,
                            kino_kuzbass.today[pozition + 1].big_logo.length
                        );
                    document.getElementById("kino_img1").innerHTML =
                        '<img src="' + img_url1 + '">';
                } else {
                    document.getElementById("kino_img1").innerHTML =
                        '<img src="' + kino_kuzbass.today[pozition + 1].logo + '">';
                }
                document.getElementById("name1").innerHTML =
                    kino_kuzbass.today[pozition + 1].name;
                document.getElementById("genre1").innerHTML =
                    kino_kuzbass.today[pozition + 1].genre;
                document.getElementById("kino_data1").innerHTML =
                    kino_kuzbass.today[pozition + 1].date;
            } else {
            ...
            if (kino_kuzbass.today.length > 2) {
                ...
                if (resolution_prefix == "_720") {
                    img_url2 =
                        "http://kuzbass.mezhdu.net/datas/users/img.php?img=" +
                        kino_kuzbass.today[pozition + 2].big_logo.substr(
                            40,
                            kino_kuzbass.today[pozition + 2].big_logo.length
                        );
                    document.getElementById("kino_img2").innerHTML =
                        '<img src="' + img_url2 + '">';
                } else {
                    document.getElementById("kino_img2").innerHTML =
                        '<img src="' + kino_kuzbass.today[pozition + 2].logo + '">';
                }
                document.getElementById("name2").innerHTML =
                    kino_kuzbass.today[pozition + 2].name;
                document.getElementById("genre2").innerHTML =
                    kino_kuzbass.today[pozition + 2].genre;
                document.getElementById("kino_data2").innerHTML =
                    kino_kuzbass.today[pozition + 2].date;
            } else {
            ...
            switch (color) {
                case "red":
                    ...
                    if (kino_kuzbass.today.length > 4) {
                        ...
                        kino_kuzbass.today.length < 5 &&
                        kino_kuzbass.today.length > 1
                    ) {
                        okonchnie = " ФИЛЬМА";
                    } else {
                        okonchnie = " ФИЛЬМ";
                    ...
                    document.getElementById("header").innerHTML =
                        "СЕГОДНЯ В КИНО:  " + kino_kuzbass.today.length + okonchnie;
                    ...
                    document.getElementById("detail").style.display = "none";
                    document.getElementById("key_info_today").innerHTML =
                ...
                case "yellow":
                    ...
                    document.getElementById("kino_img0").innerHTML =
                        '<img src="' +
                        kino_kuzbass.host_url +
                        "/img/mini_big_hall" +
                        resolution_prefix +
                        '.gif">';
                    if (resolution_prefix == "")
                        document.getElementById("name0").innerHTML =
                        "БОЛЬШОЙ ЗАЛ (316 МЕСТ)";
                    else
                        document.getElementById("name0").innerHTML =
                        "&nbsp;&nbsp;&nbsp;БОЛЬШОЙ ЗАЛ (316 МЕСТ)";
                    document.getElementById("genre0").innerHTML = "";
        ...
        this.key_press = function(button) {
                ...
                switch (button) {
                    case "left":
                        ...
                        if (kino_kuzbass.detail_visible == 0) {
                            ...
                            if (
                                kino_kuzbass.kino_active == 2 &&
                                kino_kuzbass.today_pozition == kino_kuzbass.today.length - 3
                            ) {
                                document.getElementById("right").style.display = "none";
                            } else {
                                if (
                                    kino_kuzbass.today_pozition <
                                    kino_kuzbass.today.length - 3
                                ) {
                                    document.getElementById("right").style.display = "block";
                                } else {
                                    document.getElementById("right").style.display = "none";
                    ...
                    case "right":
                        ...
                        if (kino_kuzbass.detail_visible == 0) {
                            if (
                                kino_kuzbass.kino_active != 2 &&
                                kino_kuzbass.kino_active <= kino_kuzbass.today.length - 1
                            ) {
                                kino_kuzbass.kino_active = kino_kuzbass.kino_active + 1;
                            } else {
            ...
            if (kino_kuzbass.current_layer == kino_kuzbass.schedule_layer) {
                switch (button) {
                    case "down":
                        document.getElementById("info_blok").scrollTop =
                            document.getElementById("info_blok").scrollTop + 60;
                        if (resolution_prefix == "")
                            document.getElementById("scrol_now").style.top =
                            7 +
                            Math.floor(
                                ((100 * document.getElementById("info_blok").scrollTop) /
                                    (document.getElementById("info_blok").scrollHeight - 400)) *
                                3.96
                            ) +
                            "px";
                        else
                            ...
                            Math.floor(
                                ((100 * document.getElementById("info_blok").scrollTop) /
                                    (document.getElementById("info_blok").scrollHeight - 525)) *
                                4.57
                            ) +
                            "px";
                        break;
    ...
    kino_kuzbass.init();
    kino_kuzbass.bind();
    kino_kuzbass.init_header_path('Киноцентр "Кузбасс"');
    kino_kuzbass.hide();
