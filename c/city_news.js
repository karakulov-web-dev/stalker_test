...
this.update_channels = function(){
  _debug('kvant_app.update_channels');
      for (var i = 0; i<6; i++){
          ...
          document.getElementById('kvant_channel_'+i+'_img').innerHTML = '<img src="'+kvant_app.channels.channels[i].sd_img+'">';
          document.getElementById('kvant_channel_'+i+'_title').innerHTML = kvant_app.channels.channels[i].name;
      }
      document.getElementById('kvant_gl_menu').style.display = 'none';
      if ((stb.RDir("getenv ad")!=0)||(stb.RDir("getenv ad")==''))
    {
      setTimeout("document.getElementById('kvant_ad').style.display = 'none'; document.getElementById('kvant_loading').style.display = 'none'; document.getElementById('kvant_select_channel').style.display = 'block'; document.getElementById('kvant_menu').style.display = 'block';", 4500);
    }
    else
    {
      setTimeout("document.getElementById('kvant_ad').style.display = 'none'; document.getElementById('kvant_loading').style.display = 'none'; document.getElementById('kvant_select_channel').style.display = 'block'; document.getElementById('kvant_menu').style.display = 'block';", 1500);
    }  
...
this.select_channel = function(){
  ...
  //console.log('kvant_app.select__channel='+kvant_app.select__channel);
      for (var i = 0; i<6; i++){
        document.getElementById('kvant_channel_'+i).style.backgroundImage = 'url("")';
      }
       if (resolution_prefix=='_720') 
     {
document.getElementById('prev_video0_img0').innerHTML = '<img src="'+kvant_app.channels.channels[kvant_app.select__channel].content_url+'img_hd/'+kvant_app.channels.channels[kvant_app.select__channel].video_id0+'.jpg">';
document.getElementById('prev_video0_img1').innerHTML = '<img src="'+kvant_app.channels.channels[kvant_app.select__channel].content_url+'img_hd/'+kvant_app.channels.channels[kvant_app.select__channel].video_id1+'.jpg">';
document.getElementById('prev_video0_img2').innerHTML = '<img src="'+kvant_app.channels.channels[kvant_app.select__channel].content_url+'img_hd/'+kvant_app.channels.channels[kvant_app.select__channel].video_id2+'.jpg">';
  }
     else
     {
      document.getElementById('prev_video0_img0').innerHTML = '<img src="'+kvant_app.channels.channels[kvant_app.select__channel].content_url+'img_sd/'+kvant_app.channels.channels[kvant_app.select__channel].video_id0+'.jpg">';
document.getElementById('prev_video0_img1').innerHTML = '<img src="'+kvant_app.channels.channels[kvant_app.select__channel].content_url+'img_sd/'+kvant_app.channels.channels[kvant_app.select__channel].video_id1+'.jpg">';
document.getElementById('prev_video0_img2').innerHTML = '<img src="'+kvant_app.channels.channels[kvant_app.select__channel].content_url+'img_sd/'+kvant_app.channels.channels[kvant_app.select__channel].video_id2+'.jpg">';
      }
      if (kvant_app.select__channel==0) 
        {
          document.getElementById('kvant_select_channel_right_side').style.WebkitBorderRadius = '5px';
          document.getElementById('kvant_select_channel_right_side').style.borderTopLeftRadius = '0px';
        }
           else
          {
            ...
            {
                document.getElementById('kvant_select_channel_right_side').style.WebkitBorderRadius = '5px';
                document.getElementById('kvant_select_channel_right_side').style.borderBottomLeftRadius = '0px';
            }
              else
              {
                document.getElementById('kvant_select_channel_right_side').style.WebkitBorderRadius = '5px';
      ...
      document.getElementById('kvant_channel_'+kvant_app.select__channel).style.backgroundImage = 'url("http://212.77.128.177/stalker_portal/c/template/default/i/25alfa_20.png")';
      document.getElementById('kvant_select_channel_right_side_title').innerHTML = kvant_app.channels.channels[kvant_app.select__channel].description;
      document.getElementById('kvant_select_channel_update').innerHTML = '<span>Раздел обновлен<br>'+kvant_app.channels.channels[kvant_app.select__channel].last_update+'г.</span>';
}
...
this.update_menu = function(){
      ...
      if (resolution_prefix=='_720') 
     {
      document.getElementById('kvant_video_img'+i).innerHTML = '<img src="'+kvant_app.host_url+'/img_hd/'+kvant_app.video_content.video[i].id+'.jpg">';
      document.getElementById('kvant_span_video'+i).innerHTML =kvant_app.video_content.video[i].title;
      }
     else
     {
      document.getElementById('kvant_video_img'+i).innerHTML = '<img src="'+kvant_app.host_url+'/img_sd/'+kvant_app.video_content.video[i].id+'.jpg">';
      if (kvant_app.video_content.video[i].title.length>52) 
      {
          document.getElementById('kvant_span_video'+i).innerHTML=kvant_app.video_content.video[i].title.substr(0,52)+"...";
      }
      else
      {
      document.getElementById('kvant_span_video'+i).innerHTML =kvant_app.video_content.video[i].title;
      ...
      document.getElementById('kvant_data'+i).innerHTML =kvant_app.video_content.video[i].upload_date;
      document.getElementById('kvant_duration'+i).innerHTML =kvant_app.video_content.video[i].duration;      
      //console.log('kvant_duration= '+new Date(kvant_app.video_content.video[i].duration*1000).toUTCString().split(/ /)[2]);
}
document.getElementById('kvant_number_page').innerHTML ="Стр. "+kvant_app.video_content.page+" из "+ kvant_app.video_content.pages;
...
this.update_select = function(){
      for (var i = 0; i<4; i++){
           // document.getElementById('kvant_video'+i).style.backgroundColor="";
            document.getElementById('kvant_video'+i).style.backgroundImage ='url("")';
        }
     ...
     // document.getElementById('kvant_video'+kvant_app.selected_video).style.backgroundColor="rgb(34, 101, 145)";
      document.getElementById('kvant_video'+kvant_app.selected_video).style.backgroundImage = 'url("/'+stb.portal_path+'/c/template/'+loader.template+'/i/25alfa_20.png")';
}
...
this.help_panel_update = function(){
  ...
  {
      document.getElementById('kvant_menu_key0_img').innerHTML = '<img src="/' + stb.portal_path+'/c/key_for_app/exit.png">';
      document.getElementById('kvant_menu_key1_img').innerHTML = '<img src="/' + stb.portal_path+'/c/key_for_app/ok.png">';
  ...
  {
      document.getElementById('kvant_menu_key0_img').innerHTML = '<img src="/' + stb.portal_path+'/c/key_for_app/back.png">';
      document.getElementById('kvant_menu_key1_img').innerHTML = '<img src="/' + stb.portal_path+'/c/key_for_app/ok.png">';
      document.getElementById('kvant_menu_key2_img').innerHTML = '<img src="/' + stb.portal_path+'/c/key_for_app/leftright.png">';
      document.getElementById('kvant_menu_key3_img').innerHTML = '';
      document.getElementById('kvant_menu_key0_title').innerHTML = 'Выбор канала';
      document.getElementById('kvant_menu_key1_title').innerHTML = 'Воспроизвести';
      document.getElementById('kvant_menu_key2_title').innerHTML = 'Навигация по страницам';
      document.getElementById('kvant_menu_key3_title').innerHTML = '';
  }
}

 this.reclame_load = function(){
  _debug('city_news.reclame_load');  
 if ((stb.RDir("getenv ad")!=0)||(stb.RDir("getenv ad")==''))
    {
 ...
 var xmlhttp_r = new XMLHttpRequest();
      if (resolution_prefix=='_720')
        {
              var url_r = 'http://xn--d1abdw2b.net/include/kliktv_loadinghd_inc.php';
        }
        else
        {
            var url_r = 'http://xn--d1abdw2b.net/include/kliktv_loading_inc.php';
        }
      ...
      xmlhttp_r.onreadystatechange = function() {
       if (xmlhttp_r.readyState == 4 && xmlhttp_r.status == 200) {
        ...
        {
        document.getElementById('kvant_ad_ad').innerHTML = xmlhttp_r.responseText;
        document.getElementById('kvant_loading').style.backgroundColor="rgba(128, 128, 128, 0.7)";
        document.getElementById('kvant_ad').style.display = 'block';
      }
        else

      {
         document.getElementById('kvant_ad').style.display = 'none';
       }
      }
     }
...
this.key_press = function(button){
   if (kvant_app.layer==10)
    {
      ...
      case "ok":
          kvant_app.hide();
          document.getElementById('kvant_exit_message').style.display = 'none';          
          main_menu.show();
      break;
      case "back":
            kvant_app.layer=1;
      ...
      if (kvant_app.layer==1)
  {
      ...
      case "ok":
      case "right":
            kvant_app.host_url=kvant_app.channels.channels[kvant_app.select__channel].content_url;
            kvant_app.load_video();
            kvant_app.update_header_path([{"alias" : "tab", "item" : kvant_app.channels.channels[kvant_app.select__channel].name}]);
            //[{"alias" : "tab", "item" : word['account_payment']}]
      break;
      case "menu":
      case "exit":
            kvant_app.layer=10;
            document.getElementById('kvant_exit_message').style.display = 'block';            
      break;
    }
  }
    if (kvant_app.layer==2)
    ...
    switch (button) {
      case "down": 
                  ...
                  if ((kvant_app.selected_video)==kvant_app.video_content.video.length)
                  {
      ...
      case "ok":
                var item = {
                "name" : get_word(kvant_app.video_content.video[kvant_app.selected_video].title),
                "cmd"  : "ffmpeg "+this.host_url+kvant_app.video_content.video[kvant_app.selected_video].id+".mp4"
      ...
      case "back":
            kvant_app.layer=1;
            document.getElementById('kvant_select_channel').style.display = 'block';
            document.getElementById('kvant_gl_menu').style.display = 'none';
...
//            this.key_press.bind(key.INFO, this, 'info');
    ...
    kvant_app.init();
    kvant_app.bind();
    kvant_app.init_header_path('НОВОСТИ РЕГИОНА');
    kvant_app.hide();
...
//      module.videoportal_sub.push({
	module.my_city_sub.push({
        ...
        "cmd"   : function(){
            ...
            kvant_app.load_channels();
           document.getElementById('kvant_loading').style.backgroundColor="";          
     }
    })
