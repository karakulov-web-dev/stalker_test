...
$myPicture = new pImage(850,460,$myData,TRUE);
...
$myPicture->drawText(450,25,"Динамика курса $text за неделю",$TextSettings);
$myPicture->setShadow(FALSE);
$myPicture->setGraphArea(65,50,850,430);
...
//$myPicture->autoOutput("cbr_img_graph/hd_".$currency.".png");  
$myPicture->Render("cbr_img_graph/hd_".$currency.".png");  
?>
