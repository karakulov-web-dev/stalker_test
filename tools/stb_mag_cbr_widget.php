...
if ($curr_abbr_today=='JPY'){$curr_abbr_today_2[3]=str_replace(",",".",$curr_value_today);}
if ($curr_abbr_today=='GBP'){$curr_abbr_today_2[4]=str_replace(",",".",$curr_value_today);}
} 
}
...
$usd=round($curr_abbr_today_2[1],3);
$eur=round($curr_abbr_today_2[2],3);
$jpy=round($curr_abbr_today_2[3],3);
$gbp=round($curr_abbr_today_2[4],3);

//echo "USD"."  ".round($curr_abbr_today_2[1],3)." ".$sign_USD." ".$raznost_USD;
//echo "<br>";
//echo "EUR"."  ".round($curr_abbr_today_2[2],3)." ".$sign_EUR." ".$raznost_EUR; 
