    ...
    */
    "play": function(arr) {
      ...
      "play_clip": function(url) {
        ...
        //stb.Play('http://stbmedia4-ch0.mezhdu.net:8080/films/test2.mkv');
        stb.Play(url);              
...
settings = {
  ...
  try {
     ...
     //document.getElementById('modalcaption_text').innerHTML = title+'<br><br>'+description+'<br><br>Год: '+year+'<br>Жанр: '+genre+'<br>Режисер: '+produser+'<br>Актеры: '+actors ;
