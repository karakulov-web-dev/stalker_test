...
*/
    ...
    fileref.setAttribute("href", 'css/screen' + win.height + '.css?v=4');    
    document.getElementsByTagName("head")[0].appendChild(fileref);
    loadScript('js/langs/videocatalog_ru2.js', 'load_vars()');
...
//       self.dom_obj.innerHTML = '<div id="loader">'+xmlhttp.responseText+'</div>';
       ...
       document.getElementById('loader').innerHTML=xmlhttp.responseText+'<div id="loader1"><img align="middle" src="img/loading.gif"> &nbsp;&nbsp;Загрузка</div>';
       setTimeout('document.getElementById("loader").style.display="none";',6000);
//       console.log('test2');       
        }
       }
     }
...
function fillPage() {
    ...
    byID('f_app_btn').innerHTML = lang.f_app_btn;
