  ...
  //              console.log("loading.hide4");
    ...
    */
    ...
    "playingPreparation": function(obj) {
        ...
        $.getJSON("http://video.rikt.ru/video3/stb/stb_films_history2.php?mac="+ethaddr+"&film_id="+id+"&server_id="+server+"&callback=?", function(data){
          //alert(data.result);		   
        });						   
      
       $.getJSON("http://video.rikt.ru/video3/stb/stb_url_groups.php?server_groups="+server_groups+"&callback=?", function(data){
    ...
    */
    "play": function(arr) {
        ...
        //var lenn = stb.GetMediaLen();
        //alert (lenn);
        //byID('time_total').innerHTML = lenn;
      ...
      "play_clip": function(url) {
        ...
        //stb.Play('http://stbmedia5-ch0.mezhdu.net:8080/films/72940.mkv');
...
workWithItems = {
   ...
   */
        ...
        film_time='&nbsp;&nbsp;' + '<img src="img/icon_time.png" alt="" />' + ((time_obj.hours<10)? "0" + time_obj.hours : time_obj.hours) + ':'+ ((time_obj.minuts<10)? "0" + time_obj.minuts : time_obj.minuts) + ':' + ((time_obj.seconds<10)? "0" + time_obj.seconds : time_obj.seconds);  
             }
             else {
             film_time='';
             }
          */        
                byID("frame").innerHTML += '' +
                    ...
                    //'       <p>&nbsp;' + '<img src="img/views.png" alt="" />' + viewsCount +film_time+'</p>' + "\n" +
                    //'       <p class="film_time">'+film_time+'</p>'+"\n" +
...
settings = {
  ...
  try {
     ...
     $.getJSON("http://video.rikt.ru/video3/stb/stb_mag200_caption_full_4.php?id="+id_f.toString()+"&server="+server_id.toString()+"&callback=?", function(data){
     ...
     interpretation = data.interpretation;
             ...
             var time = duration;
               ...
               document.getElementById('modalcaption_text').innerHTML = title+year+genre+dur_txt+kp_rating_txt+imdb_rating_txt+agelimit+interpretation+actors+produser;
    ...
    */
    ...
    "options":{
        ...
        "subMenuItems":[["single","repeat","list","random"],["desc","asc"],["name","year","add","views","RatingKP","RatingIMDB"],["sub_on","sub_on_eng","sub_off"]],
        "currentLevel":-1,
        "menuItem":0,
        "subMenuItem":0,
        "show":function(){
