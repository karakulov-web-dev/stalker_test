...
settings = {
  ...
  try {
    ...
    */
    ...
    "options":{
        "menuItems":["PlayModes","Quality","SortModes","Subtitles","Volume"],
        "subMenuItems":[["single","repeat","list","random"],["desc","asc"],["name","year","add","views","RatingKP","RatingIMDB"],["sub_on","sub_off"],["vol_95","vol_80","vol_60","vol_40","vol_20"]],
        "currentLevel":-1,
        "menuItem":0,
        "subMenuItem":0,
        "show":function(){
