  ...
  //              console.log("loading.hide4");
    ...
    */
    ...
    "playingPreparation": function(obj) {
        ...
        //var ethaddr = getEnvironmentValue('MACAddress');
...
settings = {
  ...
  try {
     ...
     $.getJSON("http://video.rikt.ru/video3/stb/stb_mag200_caption_full_5.php?id="+id_f.toString()+"&server="+server_id.toString()+"&callback=?", function(data){
