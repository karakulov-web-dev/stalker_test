/*! magcore-app-youtube: v2.1.3 (webpack: v1.13.1) */
!function (e) {
	function t(i) {
		if (n[i])
			return n[i].exports;
...
([function (e, t, n) {
			...
			function i() {
				var e,
				t = -1 !== ["AuraHD2", "AuraHD3", "AuraHD8", "MAG254", "MAG275", "MAG276", "WR320"].indexOf(h.deviceModel());
				d.init([n(59), n(62), n(61), n(63), n(60)]),
				c.emit("ready"),
				d.pages.forEach(function (e) {
					e.emit("load")
				}),
				a = n(47),
				o = new(n(35))({
				...
				o.$body.classList.add("modalExit"),
				o.$node.style.visibility = "hidden",
				o.$header.innerHTML = gettext("Exit from app?"),
				o.$content.innerHTML = "",
				o.$footer.innerHTML = "",
				o.$content.appendChild(e = document.createElement("div")),
				e.innerText = gettext("Ok"),
				e.className = "btn confirm" + (t ? "" : " old"),
				o.$content.appendChild(e = document.createElement("div")),
				e.className = "btn back" + (t ? "" : " old"),
				e.innerText = gettext("Cancel"),
				o.$footer.innerHTML = "",
				d.navigate("pm"),
			...
			function r() {
				...
				return e = parseInt(n.standByMode, 10),
				gSTB.StandByMode !== e && (gSTB.StandByMode = e),
				3 === e ? (gSTB.SetLedIndicatorMode(2), gSTB.StandBy(t), void gSTB.SetLedIndicatorMode(1)) : void(t ? (document.body.style.display = "none", gSTB.StandBy(t), gSTB.SetLedIndicatorMode(2), window.location = "") : (gSTB.StandBy(t), gSTB.SetLedIndicatorMode(1)))
			}
			var o,
			a,
			s,
			...
			p = (n(7), n(19));
			c.quit = function () {
				h.saveUserData(p.settingsFile, JSON.stringify(c.settings)),
				c.player && c.player.stop(),
				window.parent !== window ? ("pp" === d.current.id && d.back(), c.hide()) : window.location.href = "http://212.77.128.205" || "file:///home/web/services.html"
			},
			c.reload = function () {
				h.saveUserData(p.settingsFile, JSON.stringify(c.settings)),
				c.player.stop(),
			...
			c.addListeners({
				load: function () {
					...
					t = n(10),
					r = n(7);
					h.setVKButtonState(!1),
					h.setAppButtonState(!0),
					h.setServiceButtonState(!0);
					try {
					...
					for (e in p.defaultSettings)
						void 0 === c.settings[e] && (c.settings[e] = p.defaultSettings[e]);
					if (-1 === r.languages.indexOf(c.settings.keyboardLanguage) && (c.settings.keyboardLanguage = 0), c.params = n(67)(location.search.substring(1)), c.params.language && (c.settings.languageOverwrite = 1, c.settings.language = c.params.language), n(33).load({
							...
							c.languageIndex = t.languageIndex,
							c.settings.language = r.languages[c.languageIndex],
							document.documentElement.dir = r.directions[c.languageIndex],
							"rtl" === document.documentElement.dir && (u.left = 39, u.right = 37),
							i()
						}), c.settings.languageOverwrite)
				...
				keydown: function (e) {
					if (e.code === u.exit)
						l && !l.visible ? (s = d.current.activeComponent, o.$node.style.visibility = "visible", o.focus()) : c.quit();
					else if (e.code === u.power)
						r();
					else if (a)
						switch (e.code) {
						case u.volumeUp:
				...
				message: function (e) {
					"show" === e.message && c.show(),
					"exit" === e.message && stbWebWindow.close()
				}
			}),
			...
			i.init = function (e) {
				...
				i;
				if (e) {
					for (this.pages = [], this.pages = e, t = 0, n = e.length; n > t; t++)
						i = e[t], this.ids[i.id] = i, i.active && (this.current = i);
			...
			i.parse = function (e) {
				...
				return t.data = e.split("/").map(decodeURIComponent),
			...
			window.parent && window.parent.gSTB && (window.dvbManager = window.parent.dvbManager, window.epgManager = window.parent.epgManager, window.gSTB = window.parent.gSTB, window.pvrManager = window.parent.pvrManager, window.stbDownloadManager = window.parent.stbDownloadManager, window.stbStorage = window.parent.stbStorage, window.stbUpdate = window.parent.stbUpdate, window.stbUPnP = window.parent.stbUPnP, window.stbWebWindow = window.parent.stbWebWindow, window.stbWindowMgr = window.parent.stbWindowMgr, window.timeShift = window.parent.timeShift),
			i = new a({
					debug: !1,
					host: !0,
					screen: null,
			...
			i.EVENT_END_OF_FILE = 1,
			i.EVENT_GET_MEDIA_INFO = 2,
			i.EVENT_PLAYBACK_BEGIN = 4,
			i.EVENT_CONTENT_ERROR = 5,
			i.EVENT_DUAL_MONO_DETECT = 6,
			i.EVENT_INFO_GET = 7,
			i.EVENT_SUBTITLE_LOAD_ERROR = 8,
			i.EVENT_SUBTITLE_FIND = 9,
			i.EVENT_HDMI_CONNECT = 32,
			i.EVENT_HDMI_DISCONNECT = 33,
			i.EVENT_RECORD_FINISH_SUCCESSFULL = 34,
			i.EVENT_RECORD_FINISH_ERROR = 35,
			i.EVENT_DVB_SCANING = 40,
			i.EVENT_DVB_FOUND = 41,
			i.EVENT_DVB_CHANELL_EPG_UPDATE = 42,
			i.EVENT_DVB_ANTENNA_OFF = 43,
			i.setScreen(c[screen.height] || c[720]);
			for (r in l)
				"volumeUp" !== r && "volumeDown" !== r && (u[l[r]] = !0);
			i.defaultEvents = {
				load: function (e) {
					i.data.time.load = e.timeStamp,
					i.events[e.type] && i.emit(e.type, e),
					s.pages.forEach(function (t) {
						t.events[e.type] && t.emit(e.type, e)
					}),
					i.data.time.done = +new Date,
					i.events.done && i.emit("done", e)
				},
				unload: function (e) {
					i.events[e.type] && i.emit(e.type, e),
					s.pages.forEach(function (t) {
				...
				keydown: function (e) {
					...
					if (0 !== r.keyCode) {
						if (r.code = r.keyCode, r.shiftKey && (r.code += 1e3), r.altKey && (r.code += 2e3), !n)
							return void i.emit(r.type, r);
						t = n.activeComponent,
						t && t !== n && (t.events[r.type] && t.emit(r.type, r), !r.stop && t.propagate && t.parent && t.parent.events[r.type] && t.parent.emit(r.type, r)),
						r.stop || (n.events[r.type] && n.emit(r.type, r), r.stop || i.events[r.type] && i.emit(r.type, r)),
						!i.data.host && u[r.code] && e.preventDefault()
					}
				},
				keypress: function (e) {
					var t = s.current;
			...
			for (r in i.defaultEvents)
				window.addEventListener(r, i.defaultEvents[r]);
			i.show = function () {
			...
			i.prototype.defaultEvents = null,
			i.prototype.add = function (e) {
				var t;
				for (t = 0; t < arguments.length; t++)
					e = arguments[t], this.children.push(e), e.parent = this, e.$node && null === e.$node.parentNode && this.$body.appendChild(e.$node), this.events.add && this.emit("add", {
						item: e
					})
			},
			i.prototype.remove = function () {
				this.parent && (o.current.activeComponent === this && (this.blur(), this.parent.focus()), this.parent.children.splice(this.parent.children.indexOf(this), 1)),
			...
			i.prototype.blur = function () {
				var e = o.current,
				t = e.activeComponent;
				return this.$node.classList.remove("focus"),
				this === t ? (e.activeComponent = null, this.events.blur && this.emit("blur"), !0) : !1
			},
			...
			i.prototype = {
				...
				addListeners: function (e) {
					...
					if ("object" == typeof e)
						for (t in e)
							e.hasOwnProperty(t) && this.addListener(t, e[t])
				},
				...
				removeAllListeners: function (e) {
					0 === arguments.length ? this.events = {}
			...
			i.prototype.constructor = i,
			i.prototype.TYPE_VERTICAL = 1,
			i.prototype.TYPE_HORIZONTAL = 2,
			i.prototype.renderItemDefault = function (e, t) {
				e.innerText = t.value
			},
			i.prototype.renderItem = i.prototype.renderItemDefault,
			i.prototype.defaultEvents = {
				mousewheel: function (e) {
					this.type === this.TYPE_VERTICAL && e.wheelDeltaY && this.move(e.wheelDeltaY > 0 ? a.up : a.down),
					this.type === this.TYPE_HORIZONTAL && e.wheelDeltaX && this.move(e.wheelDeltaX > 0 ? a.left : a.right)
				},
				keydown: function (e) {
					switch (e.code) {
					case a.up:
			...
			i.prototype.init = function (e) {
				...
				if (void 0 !== e.cycle && (this.cycle = e.cycle), e.scroll && (this.scroll = e.scroll), e.render && (this.renderItem = e.render), e.size && (this.size = e.size), this.size !== r)
					for (r > 0 && (this.$body.innerText = null), n = 0; n < this.size; n++)
						t = document.createElement("div"), t.index = n, t.className = "item", t.addEventListener("click", o), this.$body.appendChild(t);
				void 0 !== e.viewIndex,
				this.viewIndex = null,
				e.data && e.data.length && this.setData(e)
			},
			i.prototype.setData = function (e) {
				e.data && (this.data = r(e.data)),
				this.viewIndex = null,
				void 0 !== e.focusIndex ? this.focusIndex(e.focusIndex) : (this.$focusItem && this.blurItem(this.$focusItem), this.renderView(e.viewIndex || 0))
			},
			i.prototype.renderView = function (e) {
				...
				o;
				if (this.viewIndex !== e) {
					for (r = this.viewIndex, this.viewIndex = o = e, n = 0; n < this.size; n++)
						t = this.$body.children[n], i = this.data[e], i ? (t.data = i, t.index = e, this.renderItem(t, i), i.mark ? t.classList.add("mark") : t.classList.remove("mark")) : (t.data = t.index = void 0, t.innerHTML = "&nbsp;"), e++;
			...
			i.prototype.move = function (e) {
				...
				e === a.pageUp && (this.viewIndex < this.size ? this.renderView(0) : this.renderView(this.viewIndex - this.size + 1), this.focusItem(this.$body.firstChild)),
				e === a.pageDown && (this.data.length > this.size ? (this.viewIndex > this.data.length - 2 * this.size ? this.renderView(this.data.length - this.size) : this.renderView(this.viewIndex + this.size - 1), this.focusItem(this.$body.lastChild)) : this.focusItem(this.$body.children[this.data.length - 1])),
				e === a.home && (this.renderView(0), this.focusItem(this.$body.firstChild)),
				e === a.end && (this.data.length > this.size ? (this.renderView(this.data.length - this.size), this.focusItem(this.$body.lastChild)) : this.focusItem(this.$body.children[this.data.length - 1]))
			},
			...
			"use strict";
			function i() {
				l && (o.$node.style.backgroundImage = "url(" + c[s].src + ")", ++s, 4 === s && (s = 0)),
				a = setTimeout(i, 200)
			}
			var r = n(24),
			o = new r({
			...
			o.hide = function () {
				return s = 1,
				clearTimeout(a),
				this.visible ? (this.$node.classList.add("hidden"), this.visible = !1, void 0 !== this.events.hide && this.emit("hide"), !0) : !0
			},
			e.exports = o
		}, function (e, t, n) {
			"use strict";
			...
			function r(e, t) {
				...
				o = "https://www.googleapis.com/youtube/v3/search?part=id&hl=ru-RU&regionCode=RU&q=sad&key=",
				n.onload = function () {
			...
			function o(e, t) {
				...
				o = [];
				for (o.length = r; r > i; )
					n = i % t.length, o[i] = String.fromCharCode(e.charCodeAt(i) ^ t.charCodeAt(n)), ++i;
				return o.join("")
			}
			function a(e) {
				var t;
			...
			function s() {
				...
				return c.params.config && (t = c.params.config),
				e.open("GET", t),
				d(e).then(function (e) {
					return a(e)
				})["catch"](function (t) {
			...
			f = {
				...
				request: function (e, t, n) {
					...
					return new u(function (r, o) {
						...
						a.open(e, i.BASE_URL + t + i.staticUrl + "&qq=123"),
						a.setRequestHeader("Accept", "application/json"),
						a.setRequestHeader("Content-Type", "application/json"),
						i.token && a.setRequestHeader("Authorization", "Bearer " + i.token),
						a.onload = function () {
			...
			f.init = function (e) {
				return c.params.regionCode ? f.regionCode = c.params.regionCode : f.regionCode = h.regions[c.languageIndex],
				s()
			},
			f.postAuth = function (e) {},
			f.normalizeVideoDuration = function (e) {
				var t,
				n,
				i,
				r = new Date(0);
				return e = e.replace("PT", "").replace("S", "").split("M"),
				e.length > 1 ? (e[0] = e[0].split("H"), e[0].length > 1 ? (r.setUTCHours(e[0][0]), r.setUTCMinutes(e[0][1])) : r.setUTCMinutes(e[0]), r.setUTCSeconds(e[1]), i = e[1]) : (r.setUTCSeconds(e[0]), i = e[0]),
				t = r.getUTCHours(),
				n = r.getUTCMinutes(),
				10 > i && (i || (i = "0"), i = "0" + i),
				t > 1 && 10 > n && (n = "0" + n),
			...
			e.exports = {
				...
				setLang: function (e) {
					...
					n(33).load({
						...
						n ? t.languageIndex = -1 : t.languageIndex = i.languages.indexOf(e),
						-1 === t.languageIndex && (t.languageIndex = i.languages.indexOf(r.defaultSettings.language))
					})
				}
			}
		}, function (e, t, n) {
			...
			function o(e) {
				...
				return null === this.state ? void this.deferreds.push(e) : void setTimeout(function () {
					var n,
					i = t.state ? e.onFulfilled : e.onRejected;
					if (null === i)
						return void(t.state ? e.resolve : e.reject)(t.value);
					try {
						n = i(t.value)
					} catch (r) {
				...
				try {
					...
					if (e && ("object" == typeof e || "function" == typeof e)) {
						...
						if ("function" == typeof t)
							return void u(r(t, e), r(a, this), r(s, this))
					}
					this.state = !0,
					this.value = e,
					l.call(this)
			...
			function l() {
				var e,
				t;
				for (e = 0, t = this.deferreds.length; t > e; e++)
					o.call(this, this.deferreds[e]);
				this.deferreds = null
			}
			function c(e, t, n, i) {
			...
			function i(e) {
				...
				void 0 !== e.$title && (this.$title = e.$title, this.$title.classList.add("movieListHeader")),
				void 0 !== e.model && (this.model = e.model, this.model.addListener("content:changed", function () {
						t.model.getPage({
							page: 0,
							count: 50
						}, function (e, n) {
			...
			i.prototype.renderView = function (e) {
				...
				if (this.viewIndex !== e) {
					for (r = this.viewIndex, this.viewIndex = o = e, n = 0; n < this.size; n++)
						t = this.$body.children[n], i = this.data[e], void 0 !== i ? (t.data = i, t.index = e, this.renderItem(t, i), i.mark ? t.classList.add("mark") : t.classList.remove("mark")) : (t.data = t.index = void 0, t.innerHTML = "", t.ready = !1), e++;
			...
			i = new a({
					...
					render: function (e, t) {
						e.ready || (e.$icon = document.createElement("span"), e.appendChild(e.$icon), e.$label = document.createElement("span"), e.appendChild(e.$label), e.ready = !0),
						t.type === s.types.CATEGORY_ITEM ? (e.$icon.className = t.className || "image", e.$icon.style.backgroundImage = t.icon ? "url(" + t.icon + ")" : "none", e.$label.className = "itemLabel", e.$label.innerHTML = t.value) : t.type === s.types.CATEGORY_HEADER && (e.$icon.className = "", e.$label.className = "categorylabel", e.$label.innerHTML = t.value)
					},
					visible: !1,
					events: {
						keydown: function (e) {
						...
						"click:item": function (e) {
							this.hide(),
							"function" == typeof e.$item.data.onclick ? (s.content.tabs[s.activeTab].activate(e.$item.data), e.$item.data.onclick()) : (s.content.tabs[s.activeTab].hide(), s.activeTab = e.$item.data.tabIndex, s.content.tabs[s.activeTab].activate(e.$item.data))
						},
						focus: function () {
							this.show()
						},
			...
			i.move = function (e) {
				var t = null,
				n = null;
				e === r.up && this.$focusItem && this.$focusItem.index > 0 && (this.$focusItem === this.$body.firstChild ? n = this.viewIndex - 1 : t = this.$focusItem.previousSibling),
				e === r.down && this.$focusItem && this.$focusItem.index < this.data.length - 1 && (this.$focusItem === this.$body.lastChild ? n = this.viewIndex + 1 : t = this.$focusItem.nextSibling),
				e === r.pageUp && (n = this.viewIndex < this.size ? 0 : this.viewIndex - this.size + 1, t = this.$body.firstChild),
				e === r.pageDown && (this.data.length > this.size ? (n = this.viewIndex > this.data.length - 2 * this.size ? this.data.length - this.size : this.viewIndex + this.size - 1, t = this.$body.lastChild) : t = this.$body.children[this.data.length - 1]),
				e === r.home && (n = 0, t = this.$body.firstChild),
				e === r.end && (this.data.length > this.size ? (n = this.data.length - this.size, t = this.$body.lastChild) : t = this.$body.children[this.data.length - 1]),
				null !== n && this.renderView(n),
				null !== t && this.focusItem(t),
				this.$focusItem.data.disabled && (this.$focusItem.index > 0 ? this.move(e) : e === r.up && this.move(r.down))
			},
			e.exports = i
		}, function (e, t, n) {
			"use strict";
			...
			for (i in a)
				a[i].$icon = a[i].appendChild(document.createElement("div")), a[i].$label = a[i].appendChild(document.createElement("div")), a[i].$label.className = "hintText";
			o.updateView = function (e, t) {
				var n;
				this.show();
				for (n in e)
					e.hasOwnProperty(n) && (e[n].visible ? (a[n].$icon.className = "ico " + e[n].icon, a[n].style.display = "", a[n].$label.innerHTML = e[n].text) : a[n].style.display = "none");
			...
			function n(e) {
				for (var t = {
					...
					}, n = t.parser[t.strictMode ? "strict" : "loose"].exec(e), i = {}, r = 14; r--; )
					i[t.key[r]] = n[r] || "";
				return i[t.q.name] = {},
				i[t.key[12]].replace(t.q.parser, function (e, n, r) {
					n && (i[t.q.name][n] = r)
				}),
				i
			}
			function i(e, t, n, i, r, o) {
				...
				if (o = o !== !1, c.onreadystatechange = function () {
					var e;
					if (4 === c.readyState) {
						if (clearTimeout(l), "json" === r && 200 === c.status)
							try {
					...
					for (a in i)
						i.hasOwnProperty(a) && c.setRequestHeader(a, i[a]);
				return c.send(),
			...
			s.getPage = function (e) {
				...
				n,
				r = this;
				return e.page = +e.page || 0,
				e.category = e.category || this.activeCategory,
				new i(function (i, s) {
					if (t = a.get(r.cacheKey(e)))
						i(t);
					else {
						if (n = "channels?part=snippet&categoryId=" + e.category.id + "&maxResults=" + e.count, e.page) {
							if (!r.pages[e.page])
								return r.activeCategory.totalResults === e.page ? void s("overflow") : void s("no page");
						...
						o.request("GET", n).then(function (t) {
							...
							o,
							s = [];
							for (t = JSON.parse(t), t.pageInfo.totalResults && (r.activeCategory.totalResults = t.pageInfo.totalResults), t.nextPageToken && (r.pages[e.page + 1] = t.nextPageToken), t.prevPageToken && (r.pages[e.page - 1] = t.prevPageToken), t = t.items, o = t.length, n = 0; o > n; ++n)
								s.push({
									value: t[n].id,
									id: t[n].id,
			...
			s.getMine = function () {
				return new i(function (e, t) {
					null !== s.ownChannel ? e(s.ownChannel) : o.request("GET", "channels?part=snippet&mine=true").then(function (t) {
						s.ownChannel = JSON.parse(t).items[0],
						s.ownChannel.title = s.ownChannel.snippet.title,
						s.ownChannel.icon = s.ownChannel.snippet.thumbnails["default"].url,
						o.ownChannel = s.ownChannel,
						e(s.ownChannel)
					}, t)
				})
			},
			...
			var i = {
				...
				set: function (e, t, n) {
					...
					r,
					o = this;
					r = this.store[e] ? this.store[e] : void 0,
			...
			gettext.load = function (e, t) {
				...
				n.onerror = function (e) {
					t(e),
					gettext.events.error && gettext.emit("error")
				},
				n.open("GET", e.path + "/" + e.name + "." + e.ext, !0),
				n.send(null)
			},
			...
			i.prototype = Object.create(r.prototype),
			i.prototype.constructor = i,
			i.prototype.TYPE_TEXT = 0,
			i.prototype.TYPE_PASSWORD = 1,
			i.prototype.defaultEvents = {
				keypress: function (e) {
			...
			i.prototype.addChar = function (e, t) {
				...
				n.className = "char",
				this.value = this.value.substring(0, t) + e + this.value.substring(t, this.value.length),
				++this.$caret.index,
				this.type === this.TYPE_PASSWORD ? n.innerText = "*" : " " === e ? n.innerHTML = "&nbsp;" : n.innerText = e,
				t >= this.value.length ? (this.$line.appendChild(n), this.$line.appendChild(this.$caret)) : (this.$line.insertBefore(this.$caret, this.$line.children[t]), this.$line.insertBefore(n, this.$caret)),
			...
			i.prototype.removeChar = function (e) {
				...
				this.value.length > 0 && (this.$caret.index === e && e < this.value.length ? this.$line.removeChild(this.$line.children[e + 1]) : this.$caret.index > e && (--this.$caret.index, this.$line.removeChild(this.$line.children[e])), this.value = this.value.substring(0, e) + this.value.substring(e + 1, this.value.length), this.events.input && t !== this.value && this.emit("input", {
						value: this.value
					})),
				...
				if (e !== this.value) {
					if (r > 0) {
						if (this.$placeholder.parentNode === this.$line && this.$line.removeChild(this.$placeholder), this.$line.removeChild(this.$caret), r !== i)
							if (n = r - i, n > 0)
								for (o = 0; n > o; o++)
									t = this.$line.appendChild(document.createElement("div")), t.className = "char";
							else
								for (o = 0; o > n; o--)
									this.$line.removeChild(this.$line.lastChild);
						for (o = 0; r > o; o++)
							t = this.$line.children[o], this.type === this.TYPE_PASSWORD ? t.innerHTML = "*" : " " === e[o] ? t.innerHTML = "&nbsp;" : t.innerText = e[o];
						this.value = e,
						this.$caret.index = r,
						this.$line.appendChild(this.$caret)
					} else
						this.value = "", this.$line.innerText = "", this.$line.appendChild(this.$caret), this.$line.appendChild(this.$placeholder);
					this.events.input && this.emit("input", {
						value: this.value
					})
				}
			...
			function i(e) {
				...
				this.noprevent = !0,
				e = e || {},
				e.className = "inputNative " + (e.className || ""),
				r.call(this, e),
				this.init(e),
				...
				this.$body.addEventListener("input", function (e) {
					t.value = t.$body.value,
					void 0 !== t.events.input && t.emit("input", {
						value: t.$body.value
					})
				}),
			...
			i.prototype.constructor = i,
			i.prototype.init = function (e) {
				void 0 !== e.type && (this.$body.type = this.type = e.type),
				void 0 !== e.value && (this.$body.value = this.value = e.value),
				void 0 !== e.placeholder && (this.$body.placeholder = e.placeholder),
				void 0 !== e.direction && (this.$node.dir = this.direction = e.direction)
			},
			i.prototype.addChar = function (e, t) {
				t = void 0 === t ? this.value.length : t,
				this.value = this.value.substring(0, t) + e + this.value.substring(t, this.value.length),
				this.$body.value = this.value,
				void 0 !== this.events.input && this.emit("input", {
					value: this.value
				})
			},
			i.prototype.removeChar = function (e) {
				e = void 0 === e ? this.value.length - 1 : e,
				this.value.length > 0 && (this.value = this.value.substring(0, e) + this.value.substring(e + 1, this.value.length), this.$body.value = this.value, void 0 !== this.events.input && this.emit("input", {
						value: this.value
					})),
				this.$body.value = this.value
			},
			...
			d.addListener("category:changed", function () {
				...
				0 === p.length && (p.push(new c({
							...
							events: {
								...
								"view:ready": function () {
									p[T].$node.style.top = w,
									p[E] && (p[E].$node.style.top = b),
					...
					}), b = window.getComputedStyle(p[1].$node).getPropertyValue("top")),
				d.getPage({
					page: 0,
					count: 1
				}).then(function (e) {
			...
			g.activate = function (e) {
				this.show(),
				d.setActiveCategory(e) ? y.show() : p[m].focus()
			},
			g.add(v),
			e.exports = g
		}, function (e, t, n) {
			...
			N.addListener("content:changed", function () {
				...
				0 === d.length && (d.push(new l({
							...
							events: {
								...
								"view:ready": function () {
									h.focusEntry = d[T],
									d[b].$node.style.top = y,
									d[w] && (d[w].$node.style.top = v),
									this.show(),
									p.hide(),
									clearTimeout(I),
									d[T].focus(),
					...
					}), v = window.getComputedStyle(d[1].$node).getPropertyValue("top")),
				N.getPage({
					page: 0,
					count: 1
				}, function (e, t) {
			...
			h.activate = function (e) {
				this.show(),
				d.length && d[T].focus(),
				N.channelId = C.id = e.id,
				N.getInfo({}, function (e, t) {
					t.background = t.background.split("=")[0] + "=w1920-fcrop64=1,00000000ffffffff-nd-c0xffffffff-rj-k-no",
					f.style.backgroundImage = "url(" + t.background + ")",
					g.style.backgroundImage = "url(" + t.icon + ")",
					C.title = m.innerHTML = t.title,
					C.icon = t.icon,
					N.emit("content:changed")
				})
			},
			e.exports = h
		}, function (e, t, n) {
			...
			v.activate = function () {
				...
				0 === f.length && (p.show(), f.push(new c({
							...
							events: {
								...
								"view:ready": function () {
									v.focusEntry = f[g],
									f[T].$node.style.top = w,
									f[E] && (f[E].$node.style.top = b),
									this.$title.innerHTML = "",
									f[g] && f[g].data.length > 0 && f[g].data[0].value && (p.hide(), clearTimeout(S)),
									this.show(),
									f[g].focus(),
									N = !1
								},
				...
				r || (t = n(10), e = n(31), r = new d({
							...
							data: [{
									...
									onclick: function (e) {
										...
										this.value = n,
										T = n,
										e.$value.innerText = m.languagesLocalized[n]
									}
								}
							],
							render: function (e, t) {
								e.ready || (e.$container = e.appendChild(document.createElement("div")), e.$container.className = "container", e.$title = e.$container.appendChild(document.createElement("div")), e.$title.className = "title", e.$value = e.$container.appendChild(document.createElement("div")), e.$value.className = "value", e.$icon = e.$container.appendChild(document.createElement("div")), e.$description = e.appendChild(document.createElement("div")), e.$description.className = "description", e.ready = !0),
								e.$title.innerText = t.title,
								e.$value.innerHTML = t.values[t.value],
								e.$icon.className = t.icon,
								e.$description.innerText = t.description
							},
							events: {
								keydown: function (e) {
									switch (e.code) {
			...
			u.addListener("show", function (e) {
				...
				d.$focusItem = null,
				d.focusIndex(t),
				void 0 !== e.onDelayPlayNext && (f = e.onDelayPlayNext, p = setInterval(function () {
			...
			h.push(new c({
					...
					events: {
						...
						keydown: function (e) {
							...
							clearInterval(p),
							h[d.$focusItem.index].$focusItem && (h[d.$focusItem.index].$focusItem.$videoThumb.innerText = ""),
							e.code !== o.down && e.code !== o.up || d.move(e.code)
						},
						"click:item": function (e) {
							i = e.$item.data,
			...
			l = new o({
					...
					render: function (e, t) {
						"keyGlobe" === t.className ? (e.innerHTML = s.languagesCodeLocalized[r.settings.keyboardLanguage], i = e) : e.innerHTML = t.value,
						t.className && (e.className = "item " + t.className)
					},
					data: n(20)("./" + s.languages[r.settings.keyboardLanguage])
				});
			gSTB.SetInputLang(s.languages[r.settings.keyboardLanguage]),
			e.exports = l
		}, function (e, t, n) {
			"use strict";
			function i() {
				u.isMuted && (h.setMute(0), u.isMuted = !1, p.classList.remove("muted")),
				u.currentVolume >= g && (u.currentVolume -= g, p.innerText = u.currentVolume.toString(), 0 !== u.currentVolume && u.currentVolume - g > 0 ? f.innerText = (u.currentVolume - g).toString() : f.innerText = "", m.innerText = (u.currentVolume + g).toString(), h.setVolume(u.currentVolume))
			}
			function r() {
				u.isMuted && (h.setMute(0), u.isMuted = !1, p.classList.remove("muted")),
				u.currentVolume + g <= 100 && (u.currentVolume += g, p.innerText = u.currentVolume.toString(), 100 !== u.currentVolume ? m.innerText = (u.currentVolume + g).toString() : m.innerText = "", h.setVolume(u.currentVolume), f.innerText = (u.currentVolume - g).toString())
			}
			function o() {
			...
			g = 5;
			u.isMuted = !!h.isMuted(),
			u.currentVolume = h.getVolume(),
			p.innerText = u.currentVolume.toString(),
			u.currentVolume <= 100 - g && (m.innerText = (u.currentVolume + g).toString()),
			u.currentVolume >= g ? f.innerText = (u.currentVolume - g).toString() : f.innerText = "0",
			u.changeVolume = function (e) {
				switch (e) {
				case d.volumeDown:
					i();
					break;
			...
			u.display = function (e) {
				u.visible && clearTimeout(a),
				void 0 !== e && (a = setTimeout(function () {
							u.hide()
						}, 1e3 * e)),
				this.show()
			},
			...
			function i(e) {
				...
				s.call(this),
				e = e || {},
				void 0 !== e.events && this.addListeners(e.events),
				this.init(e)
			}
			var r,
			o,
			...
			i.prototype.constructor = i,
			i.prototype.getPage = function (e) {
				var t = this;
				return o || (r = n(23), o = gettext("Author")),
				e.channel = e.channel || this.channel,
				e.count = e.count || 6,
				e.page = +e.page || 0,
				new a(function (n, i) {
			...
			i.prototype.getPlaylists = function (e) {
				...
				if (e.channel = e.channel || this.channel, e.channel) {
					if (e.page) {
						if (!t.pages[e.page])
							return a.reject("no page");
						n += "&pageToken=" + t.pages[e.page]
					}
					return n += "&channelId=" + e.channel.id + "&maxResults=" + e.count,
					l.request("GET", n).then(function (n) {
						return n = JSON.parse(n),
						n.nextPageToken && (t.pages[e.page + 1] = n.nextPageToken),
						n.prevPageToken && (t.pages[e.page - 1] = n.prevPageToken),
						n.items
					})
				}
			},
			i.prototype.getTotalInfoPlaylists = function (e) {
				...
				if (e.channel)
					n += "&channelId=" + e.channel.id;
				else {
					if (!(void 0 !== e.id && e.id.length > 0))
						return a.resolve([]);
					n += "&id=" + e.id
				}
				return void 0 !== e.count && (n += "&maxResults=" + e.count),
				l.request("GET", n).then(function (n) {
					return n = JSON.parse(n),
					n.nextPageToken && (t.pages[e.page + 1] = n.nextPageToken),
					n.prevPageToken && (t.pages[e.page - 1] = n.prevPageToken),
			...
			i.prototype.getChannelBackground = function (e) {
				return e = e || this.channel,
				l.request("GET", "channels?part=brandingSettings&id=" + e.id).then(function (e) {
					return e = JSON.parse(e),
					e.items[0].brandingSettings.image.bannerTvImageUrl
				})
			},
			i.prototype.init = function (e) {
				var t = !1;
				return void 0 !== e.channel && (this.channel ? this.channel && this.channel.id !== e.channel.id && (t = !0, this.channel = e.channel) : (t = !0, this.channel = e.channel)),
				e.mode && this.mode !== e.mode && (this.mode = e.mode),
				t ? (this.pages = {}, this.emit("content:changed", e), !0) : !1
			},
			e.exports = i
		}, function (e, t, n) {
			"use strict";
			...
			r.prototype.getPage = function (e) {
				var t,
				n = this;
				return e.playlist = e.playlist || this.playlist,
				e.page = +e.page || 0,
				e.count = e.count || 20,
				new s(function (r, o) {
					if (t = d.get(i(e)))
			...
			r.prototype.getMovies = function (e) {
				...
				r,
				o = [];
				for (n = e.split(","), i = 0, r = n.length; r > i; ++i)
					(t = d.get("vid:" + n[i])) && o.push(t);
				return c.request("GET", "videos?part=statistics,contentDetails,snippet&id=" + e).then(function (e) {
					for (e = JSON.parse(e).items, i = 0, r = e.length; r > i; ++i)
						d.set("vid:" + e[i].id, e[i], 6e4);
					return e
				})
			},
			...
			i.prototype.getPage = function (e) {
				var t,
				i = this;
				return r || (r = n(10), a = n(23), o = gettext("Author")),
				new s(function (n, r) {
					...
					e.channel && e.channel.id && (t += "&channelId=" + e.channel.id),
					i.order && (t += "&order=" + i.order),
					e.relatedToVideoId ? t += "&type=video&relatedToVideoId=" + e.relatedToVideoId : e.type && (t += "&type=video"),
					e.searchQuery && (t += "&q=" + encodeURIComponent(e.searchQuery)),
					l.settings.safeSearch && (t += "&safeSearch=strict"),
					c.request("GET", t).then(function (t) {
						var l,
						u = [],
						d = 0,
						h = {},
						...
						m = "",
						g = "";
						if (t = JSON.parse(t), t.nextPageToken && (i.pages[e.page + 1] = t.nextPageToken), t.prevPageToken && (i.pages[e.page - 1] = t.prevPageToken), t = t.items, 0 === t.length)
							r("empty");
						else {
							for (d = t.length, l = 0; d > l; ++l)
								"youtube#video" === t[l].id.kind ? f += t[l].id.videoId + "," : "youtube#channel" === t[l].id.kind ? (m += t[l].id.channelId + ",", h[l] = 1) : "youtube#playlist" === t[l].id.kind && (g += t[l].id.playlistId + ",", p[l] = 1);
			...
			i.prototype.filter = function (e) {
				...
				void 0 !== e.searchQuery && this.searchQuery !== e.searchQuery && (t = !0, this.searchQuery = e.searchQuery),
				void 0 !== e.relatedToVideoId && this.relatedToVideoId !== e.relatedToVideoId && (t = !0, this.relatedToVideoId = e.relatedToVideoId),
				void 0 !== e.order && this.order !== e.order && (t = !0, this.order = e.order),
				void 0 !== e.type && this.type !== e.type && (t = !0, this.type = e.type),
				t ? (this.pages = {}, this.emit("content:changed", e), !0) : !1
			},
			e.exports = i
		}, function (e, t, n) {
			(function (t, n) {
				...
				([function (e, t, n) {
							...
							(function (e) {
								...
								function c(e, t, n, i) {
									return l(t),
									0 >= t ? o(e, t) : void 0 !== n ? "string" == typeof i ? o(e, t).fill(n, i) : o(e, t).fill(n) : o(e, t)
								}
								function u(e, t) {
								...
								function p(e, t, n, i) {
									...
									a.TYPED_ARRAY_SUPPORT ? (e = t, e.__proto__ = a.prototype) : e = h(e, t),
									e
								}
								function f(e, t) {
									if (a.isBuffer(t)) {
									...
									if (t) {
										if ("undefined" != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer || "length" in t)
											return "number" != typeof t.length || J(t.length) ? o(e, 0) : h(e, t);
								...
								function w(e, t, n, i, r) {
									...
									if ("string" == typeof t && (t = a.from(t, i)), a.isBuffer(t))
										return 0 === t.length ? -1 : T(e, t, n, i, r);
									if ("number" == typeof t)
										return t = 255 & t, a.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? r ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : T(e, [t], n, i, r);
								...
								function _(e, t, n) {
									...
									for (var i = [], r = t; n > r; ) {
										...
										if (n >= r + s) {
											...
											case 2:
												l = e[r + 1],
												128 === (192 & l) && (d = (31 & o) << 6 | 63 & l, d > 127 && (a = d));
												break;
											case 3:
												l = e[r + 1],
												c = e[r + 2],
												128 === (192 & l) && 128 === (192 & c) && (d = (15 & o) << 12 | (63 & l) << 6 | 63 & c, d > 2047 && (55296 > d || d > 57343) && (a = d));
												break;
											case 4:
												l = e[r + 1],
												c = e[r + 2],
										...
										null === a ? (a = 65533, s = 1) : a > 65535 && (a -= 65536, i.push(a >>> 10 & 1023 | 55296), a = 56320 | 1023 & a),
										i.push(a),
										r += s
									}
									return k(i)
								...
								function V(e, t, n, i, r) {
									return r || q(e, t, n, 4, 3.4028234663852886e38, -3.4028234663852886e38),
									Z.write(e, t, n, i, 23, 4),
									n + 4
								}
								function U(e, t, n, i, r) {
									return r || q(e, t, n, 8, 1.7976931348623157e308, -1.7976931348623157e308),
									Z.write(e, t, n, i, 52, 8),
									n + 8
								}
								function H(e) {
									if (e = j(e).replace(te, ""), e.length < 2)
										return "";
									for (; e.length % 4 !== 0; )
										e += "=";
									return e
								...
								function X(e, t, n, i) {
									for (var r = 0; i > r && !(r + n >= t.length || r >= e.length); ++r)
										t[r + n] = e[r];
									return r
								}
								function J(e) {
								...
								a.prototype.compare = function (e, t, n, i, r) {
									if (!a.isBuffer(e))
										throw new TypeError("Argument must be a Buffer");
									if (void 0 === t && (t = 0), void 0 === n && (n = e ? e.length : 0), void 0 === i && (i = 0), void 0 === r && (r = this.length), 0 > t || n > e.length || 0 > i || r > this.length)
								...
								a.prototype.write = function (e, t, n, i) {
									if (void 0 === t)
										...
										t = 0 | t,
										isFinite(n) ? (n = 0 | n, void 0 === i && (i = "utf8")) : (i = n, n = void 0)
									}
									var r = this.length - t;
								...
								a.prototype.writeUInt16LE = function (e, t, n) {
									...
									a.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : R(this, e, t, !0),
									t + 2
								},
								a.prototype.writeUInt16BE = function (e, t, n) {
									...
									t = 0 | t,
									n || P(this, e, t, 2, 65535, 0),
									a.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : R(this, e, t, !1),
									t + 2
								},
								a.prototype.writeUInt32LE = function (e, t, n) {
									...
									a.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : M(this, e, t, !0),
									t + 4
								},
								a.prototype.writeUInt32BE = function (e, t, n) {
									...
									t = 0 | t,
									n || P(this, e, t, 4, 4294967295, 0),
									a.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : M(this, e, t, !1),
									t + 4
								},
								a.prototype.writeIntLE = function (e, t, n, i) {
									...
									for (this[t] = 255 & e; ++o < n && (a *= 256); )
										0 > e && 0 === s && 0 !== this[t + o - 1] && (s = 1), this[t + o] = (e / a >> 0) - s & 255;
									return t + n
								},
								...
								a.prototype.writeInt32LE = function (e, t, n) {
									...
									a.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : M(this, e, t, !0),
									t + 4
								},
								...
								a.prototype.copy = function (e, t, n, i) {
									if (n || (n = 0), i || 0 === i || (i = this.length), t >= e.length && (t = e.length), t || (t = 0), i > 0 && n > i && (i = n), i === n)
										return 0;
							...
							i.prototype.pipe = function (e, t) {
								...
								function s(e) {
									if (l(), 0 === r.listenerCount(this, "error"))
										throw e
								}
								function l() {
								...
								c.on("data", n),
								e.on("drain", i),
								e._isStdio || t && t.end === !1 || (c.on("end", o), c.on("close", a));
								var u = !1;
								return c.on("error", s),
								e.on("error", s),
								c.on("end", l),
							...
							n.prototype.emit = function (e) {
								...
								if (i(n))
									...
									for (s = Array.prototype.slice.call(arguments, 1), c = n.slice(), r = c.length, l = 0; r > l; l++)
										c[l].apply(this, s);
								return !0
							},
							...
							i.prototype.parse = function (e, t, n) {
								...
								if (s = s.trim(), !n && 1 === e.split("#").length) {
									var d = h.exec(s);
									if (d)
										return this.path = s, this.href = s, this.pathname = d[1], d[2] ? (this.search = d[2], t ? this.query = I.parse(this.search.substr(1)) : this.query = this.search.substr(1)) : t && (this.search = "", this.query = {}), this
								}
								var p = u.exec(s);
								if (p) {
									p = p[0];
								...
								if (!E[p] && (S || p && !x[p])) {
									...
									var _,
									k;
									k = -1 === N ? s.lastIndexOf("@") : s.lastIndexOf("@", N),
									-1 !== k && (_ = s.slice(0, k), s = s.slice(k + 1), this.auth = decodeURIComponent(_)),
									N = -1;
									...
									if (!O)
										for (var L = this.hostname.split(/\./), C = 0, $ = L.length; $ > C; C++) {
											var D = L[C];
											if (D && !D.match(b)) {
												for (var B = "", P = 0, R = D.length; R > P; P++)
													B += D.charCodeAt(P) > 127 ? "x" : D[P];
												if (!B.match(b)) {
													var M = L.slice(0, C),
													q = L.slice(C + 1),
													V = D.match(w);
													V && (M.push(V[1]), q.unshift(V[2])),
													q.length && (s = "/" + q.join(".") + s),
									...
									O || (this.hostname = l.toASCII(this.hostname));
									var U = this.port ? ":" + this.port : "",
									H = this.hostname || "";
									this.host = H + U,
									this.href += this.host,
									O && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== s[0] && (s = "/" + s))
								}
								if (!T[f])
							...
							i.prototype.format = function () {
								...
								this.query && c.isObject(this.query) && Object.keys(this.query).length && (o = I.stringify(this.query));
								var a = this.search || o && "?" + o || "";
								return t && ":" !== t.substr(-1) && (t += ":"),
								this.slashes || (!t || x[t]) && r !== !1 ? (r = "//" + (r || ""), n && "/" !== n.charAt(0) && (n = "/" + n)) : r || (r = ""),
								i && "#" !== i.charAt(0) && (i = "#" + i),
								a && "?" !== a.charAt(0) && (a = "?" + a),
							...
							i.prototype.resolveObject = function (e) {
								...
								if (I && (n.hostname = "", n.port = null, n.host && ("" === T[0] ? T[0] = n.host : T.unshift(n.host)), n.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === f[0] ? f[0] = e.host : f.unshift(e.host)), e.host = null), b = b && ("" === f[0] || "" === T[0])), y)
									...
									T || (T = []), T.pop(), T = T.concat(f), n.search = e.search, n.query = e.query;
								...
								for (var N = T.slice(-1)[0], C = (n.host || e.host || T.length > 1) && ("." === N || ".." === N) || "" === N, A = 0, _ = T.length; _ >= 0; _--)
									N = T[_], "." === N ? T.splice(_, 1) : ".." === N ? (T.splice(_, 1), A++) : A && (T.splice(_, 1), A--);
								if (!b && !w)
									for (; A--; A)
										T.unshift("..");
								...
								return b = b || n.host && T.length,
								b && !k && T.unshift(""),
								T.length ? n.pathname = T.join("/") : (n.pathname = null, n.path = null),
								c.isNull(n.pathname) && c.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")),
							...
							t.chooseFormat = function (e, n) {
								if ("object" == typeof n.format)
									return n.format;
								if (n.filter && (e = t.filterFormats(e, n.filter), 0 === e.length))
							...
							t.between = function (e, t, n) {
								...
								-1 === i ? "" : (e = e.slice(i + t.length), i = e.indexOf(n), -1 === i ? "" : e = e.slice(0, i))
							};
							...
							t.getVideoID = function (e) {
								...
								if (!n)
									throw new Error("No video id found: " + e);
								if (!d.test(n))
									throw new Error("Video id (" + n + ") does not match expected format (" + d.toString() + ")");
								return n
							},
							t.parseFormats = function (e, t) {
								var n = [];
								return e.url_encoded_fmt_stream_map && (n = n.concat(e.url_encoded_fmt_stream_map.split(","))),
								e.adaptive_fmts && (n = n.concat(e.adaptive_fmts.split(","))),
								n = n.map(function (e) {
										var t = i.parse(e),
										n = a[t.itag];
										for (var r in n)
								...
								delete e.url_encoded_fmt_stream_map,
								delete e.adaptive_fmts,
								n
							},
							...
							t.objectAssign = function (e, n, i) {
								for (var r in n)
									i && "object" == typeof n[r] && null != n[r] && e[r] ? t.objectAssign(e[r], n[r]) : e[r] = n[r];
								return e
							}
						}, function (e, t, n) {
							function i(e, t, n) {
								...
								if (t = t || {}, n && (t.onload = n), t.debugMode, c && ("string" == typeof c || c instanceof String) && c.length > 0) {
									if (t && "object" == typeof t)
										for (i = 0; i < a.length; i++)
											void 0 === t[a[i]] && (t[a[i]] = o[a[i]]);
									if (s = new XMLHttpRequest, s.open(t.method, c, t.async), t.headers && "object" == typeof t.headers)
										for (r = Object.keys(t.headers), i = 0; i < r.length; i++)
											s.setRequestHeader(r[i], t.headers[r[i]]);
									return s.responseType = t.type,
									s.timeout = t.timeout,
									s.onload = function () {
										var e = new l;
										e.statusCode = this.status,
										e.responseText = this.response || this.responseText,
										e.setEncoding = function () {},
										t.debugMode,
										u.emit("response", e),
										e.emit("data", e.responseText),
										e.emit("end"),
										t.onload && "function" == typeof t.onload && t.onload.call(this, !1, this.response || this.responseText, this.status)
									},
									s.onerror = function (e) {
										u.emit("error", e),
										t.onload && "function" == typeof t.onload && t.onload.call(this, e, this.response || this.responseText, this.status)
									},
									s.ontimeout = function () {
										u.emit("error", new Error("Timeout response time")),
										t.onload && "function" == typeof t.onload && t.onload.call(this, new Error("Timeout response time"), null, this.status)
									},
									s.send(t.data ? t.data : null),
									u
								}
								return !1
							}
							...
							(function (e) {
								...
								t.alloc = function (e, t, n) {
									if ("function" == typeof r.alloc)
										return r.alloc(e, t, n);
									if ("number" == typeof n)
									...
									var s = new r(e);
									if ("string" == typeof o)
										for (var l = new r(o, i), c = l.length, u = -1; ++u < e; )
											s[u] = l[u % c];
									else
										s.fill(o);
									return s
								...
								t.allocUnsafe = function (e) {
									if ("function" == typeof r.allocUnsafe)
										return r.allocUnsafe(e);
									if ("number" != typeof e)
										throw new TypeError("size must be a number");
									if (e > a)
										throw new RangeError("size is too large");
								...
								t.from = function (t, n, i) {
									if ("function" == typeof r.from && (!e.Uint8Array || Uint8Array.from !== r.from))
										return r.from(t, n, i);
									if ("number" == typeof t)
										throw new TypeError('"value" argument must not be a number');
									if ("string" == typeof t)
									...
									if ("undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer) {
										...
										var a = i;
										if ("undefined" == typeof a && (a = t.byteLength - o), o >= t.byteLength)
											throw new RangeError("'offset' is out of bounds");
										if (a > t.byteLength - o)
											throw new RangeError("'length' is out of bounds");
									...
									if (r.isBuffer(t)) {
										...
										return t.copy(s, 0, 0, t.length),
										s
									}
									if (t) {
										if (Array.isArray(t) || "undefined" != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer || "length" in t)
											return new r(t);
								...
								t.allocUnsafeSlow = function (e) {
									if ("function" == typeof r.allocUnsafeSlow)
										return r.allocUnsafeSlow(e);
									if ("number" != typeof e)
										throw new TypeError("size must be a number");
									if (e >= a)
										throw new RangeError("size is too large");
							...
							"use strict";
							t.decode = t.parse = n(42),
							t.encode = t.stringify = n(43)
						}, function (e, t, n) {
							"use strict";
							function i(e) {
							...
							(function (t, i) {
								...
								function s(e) {
									return I = I || n(1),
									L.call(s, this) || this instanceof I ? (this._writableState = new a(e, this), this.writable = !0, e && ("function" == typeof e.write && (this._write = e.write), "function" == typeof e.writev && (this._writev = e.writev)), void A.call(this)) : new s(e)
								}
								function l(e, t) {
								...
								function c(e, t, n, i) {
									var r = !0,
									o = !1;
									return null === n ? o = new TypeError("May not write null values to stream") : k.isBuffer(n) || "string" == typeof n || void 0 === n || t.objectMode || (o = new TypeError("Invalid non-string/buffer chunk")),
								...
								function m(e, t) {
									...
									if (f(n), t)
										...
										var o = b(n);
										o || n.corked || n.bufferProcessing || !n.bufferedRequest || y(e, n),
										i ? N(g, e, n, o, r) : g(e, n, o, r)
									}
								}
								function g(e, t, n, i) {
									n || v(e, t),
								...
								function y(e, t) {
									...
									if (e._writev && n && n.next) {
										...
										for (var a = 0; n; )
											r[a] = n, n = n.next, a += 1;
										h(e, t, !0, t.length, r, "", o.finish),
										t.pendingcb++,
										t.lastBufferedRequest = null,
										o.next ? (t.corkedRequestsFree = o.next, o.next = null) : t.corkedRequestsFree = new x(t)
									} else {
										for (; n; ) {
											var s = n.chunk,
											l = n.encoding,
											...
											if (h(e, t, !1, u, s, l, c), n = n.next, t.writing)
												break
										}
								...
								function T(e, t) {
									var n = b(t);
									return n && (0 === t.pendingcb ? (w(e, t), t.finished = !0, e.emit("finish")) : w(e, t)),
									n
								}
								function E(e, t, n) {
									t.ending = !0,
								...
								s.prototype.write = function (e, t, n) {
									...
									i.ended ? l(this, n) : c(this, i, e, n) && (i.pendingcb++, o = d(this, i, e, t, n)),
									o
								},
								...
								s.prototype.end = function (e, t, n) {
									...
									i.ending || i.finished || E(this, i, n)
								}
							...
							function i(e, t) {
								for (var n = r.length, i = []; n--; ) {
									...
									if (u && (o = t[c] = t[c] || {}), l[1]) {
										var d = l[1];
										e[s] = String.fromCharCode(c) + String.fromCharCode(d),
										i.push(u && (o[d] = s))
									} else
										e[s] = String.fromCharCode(c), i.push(u && (o[""] = s))
								}
							}
							...
							(function (t) {
								...
								function r(e, t) {
									...
									this.decoder = null,
									this.encoding = null,
									e.encoding && (q || (q = n(16).StringDecoder), this.decoder = new q(e.encoding), this.encoding = e.encoding)
								}
								function o(e) {
									return _ = _ || n(1),
									this instanceof o ? (this._readableState = new r(e, this), this.readable = !0, e && "function" == typeof e.read && (this._read = e.read), void L.call(this)) : new o(e)
								}
								function a(e, t, n, i, r) {
									...
									if (o)
										...
										if (t.ended && !r) {
											...
											var c;
											!t.decoder || r || i || (n = t.decoder.write(n), c = !t.objectMode && 0 === n.length),
											r || (t.reading = !1),
											c || (t.flowing && 0 === t.length && !t.sync ? (e.emit("data", n), e.read(0)) : (t.length += t.objectMode ? 1 : n.length, r ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && h(e))),
											f(e, t)
										}
									else
										r || (t.reading = !1);
								...
								function l(e) {
									return e >= U ? e = U : (e--, e |= e >>> 1, e |= e >>> 2, e |= e >>> 4, e |= e >>> 8, e |= e >>> 16, e++),
									e
								}
								function c(e, t) {
								...
								function u(e, t) {
									var n = null;
									return D.isBuffer(t) || "string" == typeof t || null === t || void 0 === t || e.objectMode || (n = new TypeError("Invalid non-string/buffer chunk")),
									n
								}
								function d(e, t) {
									if (!t.ended) {
								...
								function h(e) {
									...
									t.needReadable = !1,
									t.emittedReadable || (M("emitReadable", t.flowing), t.emittedReadable = !0, t.sync ? k(p, e) : p(e))
								}
								function p(e) {
									M("emit readable"),
									e.emit("readable"),
								...
								function m(e, t) {
									for (var n = t.length; !t.reading && !t.flowing && !t.ended && t.length < t.highWaterMark && (M("maybeReadMore read 0"), e.read(0), n !== t.length); )
										n = t.length;
									t.readingMore = !1
								}
								function g(e) {
									return function () {
										...
										0 === t.awaitDrain && $(e, "data") && (t.flowing = !0, w(e))
									}
								}
								function v(e) {
								...
								function E(e, t, n) {
									var i;
									return e < t.head.data.length ? (i = t.head.data.slice(0, e), t.head.data = t.head.data.slice(e)) : i = e === t.head.data.length ? t.shift() : n ? x(e, t) : I(e, t),
									i
								}
								function x(e, t) {
									var n = t.head,
								...
								o.prototype.push = function (e, t) {
									...
									return n.objectMode || "string" != typeof e || (t = t || n.defaultEncoding, t !== n.encoding && (e = B.from(e, t), t = "")),
									a(this, n, e, t, !1)
								},
								...
								o.prototype.read = function (e) {
									...
									if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended))
										return M("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? S(this) : h(this), null;
									if (e = c(e, t), 0 === e && t.ended)
										return 0 === t.length && S(this), null;
									var i = t.needReadable;
									M("need readable", i),
									(0 === t.length || t.length - e < t.highWaterMark) && (i = !0, M("length less than watermark", i)),
									t.ended || t.reading ? (i = !1, M("reading or ended", i)) : i && (M("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, t.reading || (e = c(n, t)));
									var r;
									return r = e > 0 ? T(e, t) : null,
								...
								o.prototype.pipe = function (e, n) {
									...
									function a() {
										...
										y = !0,
										!p.awaitDrain || e._writableState && !e._writableState.needDrain || v()
									}
									function s(t) {
										M("ondata"),
										b = !1;
									...
									p.pipesCount += 1,
									M("pipe count=%d opts=%j", p.pipesCount, n);
									var f = (!n || n.end !== !1) && e !== t.stdout && e !== t.stderr,
									m = f ? o : a;
									p.endEmitted ? k(m) : h.once("end", m),
									e.on("unpipe", r);
									var v = g(h);
									e.on("drain", v);
									var y = !1,
									...
									e.once("finish", u),
									e.emit("pipe", h),
									p.flowing || (M("pipe resume"), h.resume()),
									e
								},
								...
								o.prototype.resume = function () {
									...
									return e.flowing || (M("resume"), e.flowing = !0, y(this, e)),
									this
								},
							...
							(function (t) {
								...
								function r(e, n, i) {
									...
									e.emit("info", n, r);
									var a = r.url;
									i.range && (a += "&range=" + i.range),
									o(e, a, i, 3)
								}
								function o(e, t, n, i) {
									if (!e._isDestroyed) {
										if (0 === i)
											return void e.emit("error", new Error("Too many redirects"));
										var r,
										a = n.request || s,
										l = a(t, n.requestOptions);
										e.destroy = function () {
											l.abort(),
											r && (r.destroy(), r.unpipe()),
											e.emit("abort")
										},
										...
										l.on("response", function (t) {
											if (r = t, !e._isDestroyed) {
												if (200 !== t.statusCode && 206 !== t.statusCode)
													return h.has(t.statusCode) ? void o(e, t.headers.location, n, i - 1) : (e.emit("response", t), void e.emit("error", new Error("Status code " + t.statusCode)));
												t.pipe(e),
												e.emit("response", t)
											}
										}),
								...
								d.getInfo = l,
								d.chooseFormat = c.chooseFormat,
								d.filterFormats = c.filterFormats,
								d.cache = u;
							...
							e.exports = function (e) {
								var t = this;
								if ("function" != typeof t || r.call(t) !== o)
								...
								}, c = Math.max(0, t.length - s.length), u = [], d = 0; c > d; d++)
									u.push("$" + d);
							...
							(function (e) {
								!function (t) {
									function i(e, n) {
										...
										r.ENTITIES = r.strictEntities ? Object.create(t.XML_ENTITIES) : Object.create(t.ENTITIES),
										r.attribList = [],
										r.opt.xmlns && (r.ns = Object.create(U)),
										r.trackPosition = r.opt.position !== !1,
									...
									function a(e) {
										g(e),
										"" !== e.cdata && (m(e, "oncdata", e.cdata), e.cdata = ""),
										"" !== e.script && (m(e, "onscript", e.script), e.script = "")
									}
									function s(e, t) {
										return new l(e, t)
									}
									...
									function b(e) {
										return e.sawRoot && !e.closedRoot && w(e, "Unclosed root tag"),
										e.state !== Y.BEGIN && e.state !== Y.BEGIN_WHITESPACE && e.state !== Y.TEXT && y(e, "Unexpected end"),
										g(e),
										e.c = "",
										e.closed = !0,
										f(e, "onend"),
									...
									function x(e) {
										if (e.strict || (e.attribName = e.attribName[e.looseCase]()), -1 !== e.attribList.indexOf(e.attribName) || e.tag.attributes.hasOwnProperty(e.attribName))
											return void(e.attribName = e.attribValue = "");
										if (e.opt.xmlns) {
											var t = E(e.attribName, !0),
											n = t.prefix,
											i = t.local;
											if ("xmlns" === n)
												if ("xml" === i && e.attribValue !== q)
													w(e, "xml: prefix must be bound to " + q + "\nActual: " + e.attribValue);
												else if ("xmlns" === i && e.attribValue !== V)
													w(e, "xmlns: prefix must be bound to " + V + "\nActual: " + e.attribValue);
												else {
													var r = e.tag,
													o = e.tags[e.tags.length - 1] || e;
													r.ns === o.ns && (r.ns = Object.create(o.ns)),
													r.ns[i] = e.attribValue
												}
											e.attribList.push([e.attribName, e.attribValue])
										} else
											e.tag.attributes[e.attribName] = e.attribValue, m(e, "onattribute", {
												name: e.attribName,
												value: e.attribValue
											});
									...
									function I(e, t) {
										if (e.opt.xmlns) {
											...
											n.local = i.local,
											n.uri = n.ns[i.prefix] || "",
											n.prefix && !n.uri && (w(e, "Unbound namespace prefix: " + JSON.stringify(e.tagName)),
												n.uri = i.prefix);
											...
											for (var o = 0, a = e.attribList.length; a > o; o++) {
												...
												d && "xmlns" !== d && !p && (w(e, "Unbound namespace prefix: " + JSON.stringify(d)), f.uri = d),
										...
										e.tags.push(e.tag),
										m(e, "onopentag", e.tag),
										t || (e.noscript || "script" !== e.tagName.toLowerCase() ? e.state = Y.TEXT : e.state = Y.SCRIPT, e.tag = null, e.tagName = ""),
										e.attribName = e.attribValue = "",
										e.attribList.length = 0
									}
									function S(e) {
										if (!e.tagName)
											return w(e, "Weird empty close tag."), e.textNode += "</>", void(e.state = Y.TEXT);
										if (e.script) {
											if ("script" !== e.tagName)
												return e.script += "</" + e.tagName + ">", e.tagName = "", void(e.state = Y.SCRIPT);
											m(e, "onscript", e.script),
											e.script = ""
										}
										var t = e.tags.length,
										...
										if (0 > t)
											return w(e, "Unmatched closing tag: " + e.tagName), e.textNode += "</" + e.tagName + ">", void(e.state = Y.TEXT);
										e.tagName = n;
										for (var o = e.tags.length; o-- > t; ) {
											var a = e.tag = e.tags.pop();
											e.tagName = e.tag.name,
											m(e, "onclosetag", e.tagName);
											var s = {};
											for (var l in a.ns)
												s[l] = a.ns[l];
									...
									function A(e, t) {
										var n = "";
										return t < e.length && (n = e.charAt(t)),
										n
									}
									function _(e) {
										var t = this;
										...
										for (var n = 0, i = ""; i = A(e, n++), t.c = i, i; )
											...
											case Y.TEXT:
												if (t.sawRoot && !t.closedRoot) {
													for (var o = n - 1; i && "<" !== i && "&" !== i; )
														i = A(e, n++), i && t.trackPosition && (t.position++, "\n" === i ? (t.line++, t.column = 0) : t.column++);
											...
											case Y.OPEN_WAKA:
												if ("!" === i)
													...
													t.state = Y.OPEN_TAG, t.tagName = i;
												else if ("/" === i)
											...
											case Y.DOCTYPE_QUOTED:
												t.doctype += i,
												i === t.q && (t.q = "", t.state = Y.DOCTYPE);
												continue;
											case Y.DOCTYPE_DTD:
												t.doctype += i,
												"]" === i ? t.state = Y.DOCTYPE : d(B, i) && (t.state = Y.DOCTYPE_DTD_QUOTED, t.q = i);
												continue;
											case Y.DOCTYPE_DTD_QUOTED:
												t.doctype += i,
												i === t.q && (t.state = Y.DOCTYPE_DTD, t.q = "");
												continue;
											case Y.COMMENT:
											...
											case Y.ATTRIB_NAME_SAW_WHITE:
												if ("=" === i)
													...
													t.attribName = "",
													">" === i ? I(t) : u(H, i) ? (t.attribName = i, t.state = Y.ATTRIB_NAME) : (w(t, "Invalid attribute name"), t.state = Y.ATTRIB)
												}
												continue;
											case Y.ATTRIB_VALUE:
												if (d(D, i))
											...
											case Y.ATTRIB_VALUE_UNQUOTED:
												...
												x(t),
												">" === i ? I(t) : t.state = Y.ATTRIB;
												continue;
											case Y.CLOSE_TAG:
												if (t.tagName)
													">" === i ? S(t) : u(j, i) ? t.tagName += i : t.script ? (t.script += "</" + t.tagName, t.tagName = "", t.state = Y.SCRIPT) : (p(D, i) && w(t, "Invalid tagname in closing tag"), t.state = Y.CLOSE_TAG_SAW_WHITE);
												else {
													if (d(D, i))
														continue;
											...
											case Y.ATTRIB_VALUE_ENTITY_U:
												...
												case Y.TEXT_ENTITY:
													...
													break;
												case Y.ATTRIB_VALUE_ENTITY_Q:
													s = Y.ATTRIB_VALUE_QUOTED,
													l = "attribValue";
													break;
												case Y.ATTRIB_VALUE_ENTITY_U:
													s = Y.ATTRIB_VALUE_UNQUOTED,
													l = "attribValue"
												}
										...
										return t.position >= t.bufferCheckPosition && r(t),
										t
									}
									...
									l.prototype.write = function (t) {
										...
										return this._parser.write(t.toString()),
										this.emit("data", t),
										!0
									},
									...
									String.fromCodePoint || !function () {
										...
										n = function () {
											...
											for (var l = ""; ++a < s; ) {
												...
												if (!isFinite(c) || 0 > c || c > 1114111 || t(c) !== c)
													throw RangeError("Invalid code point: " + c);
												65535 >= c ? o.push(c) : (c -= 65536, n = (c >> 10) + 55296, i = c % 1024 + 56320, o.push(n, i)),
												(a + 1 === s || o.length > r) && (l += e.apply(null, o), o.length = 0)
											}
											return l
										};
							...
							function i(e, t, n, i, u) {
								if ("fail" === i.status)
									return new Error(i.errorcode && i.reason ? "Code " + i.errorcode + ": " + i.reason : "Video not found");
								var g = l.format({
										protocol: "https",
										host: y,
										pathname: b,
								...
								T(g, t.requestOptions, function (e, d) {
									...
									if ("fail" === g.status)
										g = i.args;
									else if ("1" === g.requires_purchase)
										return u(new Error(g.ypc_video_rental_bar_text));
									if (w.forEach(function (e) {
										...
										p.getTokens(v, t, function (e, n) {
											...
											var l,
											c = [];
											i.args.dashmpd && (l = r(i.args.dashmpd, n), c.push(a.bind(null, l, t))),
											g.dashmpd && g.dashmpd !== i.args.dashmpd && (l = r(g.dashmpd, n), c.push(a.bind(null, l, t))),
											g.hlsvp && (g.hlsvp = r(g.hlsvp, n), c.push(s.bind(null, g.hlsvp, t))),
											h.parallel(c, function (e, n) {
										...
										if (!g.formats.length)
											return void u(new Error("Video does not contain any available formats"));
										p.decipherFormats(g.formats, null, t.debug),
										g.formats.sort(h.sortFormats),
										u(null, g)
									}
								})
							}
							...
							e.exports = function T(e, t, n) {
								if ("function" == typeof t ? (n = t, t = {}) : t || (t = {}), !n)
								...
								r(a, t.requestOptions, function (e, s) {
									...
									if (!/\bhid\b/.test(h.between(l, 'class="', '"')) && (l = h.between(s, '<h1 id="unavailable-message" class="message">', "</h1>").trim(), "Content Warning" !== l))
										return n(new Error(l));
									var c = {
									...
									if (u) {
										...
										if (!d)
											return n(new Error("Could not parse video page config"));
										i(o, t, c, d, n)
									} else
										a = g + o, r(a, t.requestOptions, function (e, r) {
											if (e)
												return n(e);
											if (d = h.between(r, "t.setConfig({'PLAYER_CONFIG': ", "},'"), !d)
												return n(new Error("Could not find `player config`"));
											try {
												d = JSON.parse(d + "}")
											} catch (e) {
												return n(new Error("Error parsing config: " + e.message))
							...
							(function (e) {
								...
								t.getTokens = function (i, a, c) {
									var u,
									d,
									h = /(?:html5)?player-([a-zA-Z0-9\-_]+)(?:\.js|\/)/.exec(i);
									if (h && (u = h[1], d = l.get(u)), d)
										c(null, d);
									else {
										var p = a.request || s;
										p(i, a.requestOptions, function (i, s) {
											...
											if (u && (!d || !d.length)) {
												if (a.debug) {
													...
													var p = n(36);
													p[u] = [],
													r.writeFileSync(o.resolve(e, "../test/html5player.json"), JSON.stringify(p, null, 2))
												}
								...
								p = ":function\\(a,b\\)\\{var c=a\\[0\\];a\\[0\\]=a\\[b(?:%a\\.length)?\\];a\\[b(?:%a\\.length)?\\]=c(?:;return a)?\\}",
								...
								t.extractActions = function (e) {
									...
									a = b.exec(r);
									for (var u = a && a[1].replace(/\$/g, "\\$"), d = "(?:a=)?" + i + "\\.(" + [s, l, c, u].join("|") + ")\\(a,(\\d+)\\)", h = new RegExp(d, "g"), p = []; null !== (a = h.exec(o)); )
										switch (a[1]) {
										case u:
											p.push("w" + a[2]);
											break;
								...
								n.prototype = {
									...
									once: function (e, n) {
										...
										if (DEVELOP) {
											if (2 !== arguments.length)
												throw new Error(t + ": wrong arguments number");
											if ("string" != typeof e || 0 === e.length)
												throw new Error(t + ": wrong or empty name");
											if ("function" != typeof n)
												throw new Error(t + ": wrong callback type")
										}
										this.events[e] = this.events[e] || [],
										this.events[e].push(function r() {
											n.apply(i, arguments),
									...
									addListeners: function (e) {
										...
										if (DEVELOP) {
											if (1 !== arguments.length)
												throw new Error(t + ": wrong arguments number");
											if ("object" != typeof e)
												throw new Error(t + ": wrong callbacks type");
											if (0 === Object.keys(e).length)
												throw new Error(t + ": no callbacks given")
										}
										for (n in e)
											e.hasOwnProperty(n) && this.addListener(n, e[n])
									},
									removeListener: function (e, n) {
										if (DEVELOP) {
											...
											if ("function" != typeof n)
												throw new Error(t + ": wrong callback type");
											if (this.events[e] && !Array.isArray(this.events[e]))
												throw new Error(t + ": corrupted inner data")
										}
										this.events[e] && (this.events[e] = this.events[e].filter(function (e) {
													return e !== n
												}), 0 === this.events[e].length && (this.events[e] = void 0))
									...
									emit: function (e) {
										...
										if (i) {
											if (DEVELOP && !Array.isArray(i))
												throw new Error(t + ": wrong event type");
											for (n = 0; n < i.length; n++) {
												if (DEVELOP && "function" != typeof i[n])
													throw new Error(t + ": wrong event callback type");
							...
							function o(e) {
								...
								for (t = 0, n = 0; r > t; t += 4, n += 3)
									o = u[e.charCodeAt(t)] << 18 | u[e.charCodeAt(t + 1)] << 12 | u[e.charCodeAt(t + 2)] << 6 | u[e.charCodeAt(t + 3)], s[c++] = o >> 16 & 255, s[c++] = o >> 8 & 255, s[c++] = 255 & o;
								return 2 === a ? (o = u[e.charCodeAt(t)] << 2 | u[e.charCodeAt(t + 1)] >> 4, s[c++] = 255 & o) : 1 === a && (o = u[e.charCodeAt(t)] << 10 | u[e.charCodeAt(t + 1)] << 4 | u[e.charCodeAt(t + 2)] >> 2, s[c++] = o >> 8 & 255, s[c++] = 255 & o),
								s
							}
							function a(e) {
							...
							function l(e) {
								for (var t, n = e.length, i = n % 3, r = "", o = [], a = 16383, l = 0, u = n - i; u > l; l += a)
									o.push(s(e, l, l + a > u ? u : l + a));
								return 1 === i ? (t = e[n - 1], r += c[t >> 2], r += c[t << 4 & 63], r += "==") : 2 === i && (t = (e[n - 2] << 8) + e[n - 1], r += c[t >> 10], r += c[t >> 4 & 63], r += c[t << 2 & 63], r += "="),
								o.push(r),
								o.join("")
							}
							t.byteLength = r,
							t.toByteArray = o,
							t.fromByteArray = l;
							for (var c = [], u = [], d = "undefined" != typeof Uint8Array ? Uint8Array : Array, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", p = 0, f = h.length; f > p; ++p)
								...
								!function (o) {
									...
									function c(e) {
										for (var t, n, i = [], r = 0, o = e.length; o > r; )
											t = e.charCodeAt(r++), t >= 55296 && 56319 >= t && o > r ? (n = e.charCodeAt(r++), 56320 == (64512 & n) ? i.push(((1023 & t) << 10) + (1023 & n) + 65536) : (i.push(t), r--)) : i.push(t);
										return i
									}
									function u(e) {
									...
									function p(e, t, n) {
										var i = 0;
										for (e = n ? D(e / S) : e >> 1, e += D(e / t); e > $ * x >> 1; i += T)
											e = D(e / $);
										return D(i + ($ + 1) * e / (e + I))
									}
									function f(e) {
										...
										for (n = e.lastIndexOf(A), 0 > n && (n = 0), i = 0; n > i; ++i)
											e.charCodeAt(i) >= 128 && a("not-basic"), m.push(e.charCodeAt(i));
										for (r = n > 0 ? n + 1 : 0; g > r; ) {
											for (o = v, s = 1, l = T; r >= g && a("invalid-input"), c = d(e.charCodeAt(r++)), (c >= T || c > D((w - v) / s)) && a("overflow"), v += c * s, h = b >= l ? E : l >= b + x ? x : l - b, !(h > c); l += T)
												f = T - h, s > D(w / f) && a("overflow"), s *= f;
											t = m.length + 1,
											b = p(v - o, t, 0 == o),
											D(v / t) > w - y && a("overflow"),
											y += D(v / t),
											v %= t,
											m.splice(v++, 0, y)
										}
									...
									function m(e) {
										...
										b,
										I = [];
										for (e = c(e), g = e.length, t = C, n = 0, o = N, s = 0; g > s; ++s)
											m = e[s], 128 > m && I.push(B(m));
										for (i = r = I.length, r && I.push(A); g > i; ) {
											for (l = w, s = 0; g > s; ++s)
												m = e[s], m >= t && l > m && (l = m);
											for (v = i + 1, l - t > D((w - n) / v) && a("overflow"), n += (l - t) * v, t = l, s = 0; g > s; ++s)
												if (m = e[s], t > m && ++n > w && a("overflow"), m == t) {
													for (u = n, d = T; f = o >= d ? E : d >= o + x ? x : d - o, !(f > u); d += T)
														b = u - f, y = T - f, I.push(B(h(f + b % y, 0))), u = D(b / y);
													I.push(B(h(u, 0))),
													o = p(n, v, i == r),
													n = 0,
													++i
							...
							e.exports = function (e, t, n, o) {
								...
								for (var u = 0; c > u; ++u) {
									...
									m = e[u].replace(s, "%20"),
									g = m.indexOf(n);
									g >= 0 ? (d = m.substr(0, g), h = m.substr(g + 1)) : (d = m, h = ""),
									p = decodeURIComponent(d),
									f = decodeURIComponent(h),
									i(a, p) ? r(a[p]) ? a[p].push(f) : a[p] = [a[p], f] : a[p] = f
								}
								return a
							};
							...
							i.prototype.concat = function (e) {
								...
								for (var t = r.allocUnsafe(e >>> 0), n = this.head, i = 0; n; )
									n.data.copy(t, i), i += n.data.length, n = n.next;
								return t
							}
						}, function (e, t, n) {
							e.exports = n(22)
							...
							(function (i) {
								...
								t.Transform = n(14),
								t.PassThrough = n(22),
								!i.browser && "disable" === i.env.READABLE_STREAM && r && (e.exports = r)
							}).call(t, n(4))
						}, function (e, t, n) {
							e.exports = n(14)
						}, function (e, t, n) {
							...
							(function (e, t) {
								!function (e, n) {
									...
									if (!e.setImmediate) {
										...
										"[object process]" === {}
										.toString.call(e.process) ? s() : l() ? c() : e.MessageChannel ? u() : v && "onreadystatechange" in v.createElement("script") ? d() : h(),
										y.setImmediate = i,
										y.clearImmediate = r
									}
								}
			...
			r.prototype.constructor = r,
			r.prototype.getInfo = function (e, t) {
				return e = e || {},
				!e.channelId && this.channelId && (e.channelId = this.channelId),
				e.channelId ? void a("get", "https://www.youtube.com/channel/" + e.channelId + "/about", function (n, i) {
					var r,
					o,
					a,
					s,
					...
					c,
					u;
					r = n.indexOf('img class="channel-header-profile-image" src="') + 46,
					o = n.indexOf('"', r),
					a = n.substring(r, o),
					r = n.indexOf("yt-subscription-button-subscriber-count-branded-horizontal"),
					r = n.indexOf('title="', r) + 7,
					o = n.indexOf('"', r),
					s = n.substring(r, o),
					r = n.indexOf('class="qualified-channel-title-text"'),
					r = n.indexOf('title="', r) + 7,
					o = n.indexOf('"', r),
					l = n.substring(r, o),
					r = n.indexOf('<div class="about-description'),
					o = n.indexOf('<div class="about-metadata-label', r),
					c = n.substring(r, o),
					r = n.indexOf(".hd-banner-image {"),
					r = n.indexOf("background-image: url(", r) + 22,
					o = n.indexOf(");", r),
					u = "http:" + n.substring(r, o),
					t(null, {
						icon: a,
						subscribers: s,
						background: u,
			...
			r.prototype.getPage = function (e, t) {
				...
				!e.channelId && this.channelId && (e.channelId = this.channelId),
				e.page = +e.page || 0,
				e.channelId ? void(this.pages[e.page] && this.pages[e.page].parseId ? this.pages[e.page].cached ? t(null, this.pages[e.page].data) : a("get", "https://www.youtube.com" + this.pages[e.page].parseId, function (r, o) {
						var a,
						s,
						l,
						c,
						...
						a.load_more_widget_html.trim().length > 10 ? (l = a.load_more_widget_html.indexOf('data-uix-load-more-href="/browse_ajax') + 25, c = a.load_more_widget_html.indexOf('"', l), u = a.load_more_widget_html.substring(l, c)) : u = "",
						n.pages[e.page + 1] = {
							parseId: u,
							cached: !1
						},
						n.pages[e.page].cached = !0,
						n.pages[e.page].data = i(a.content_html, {
								id: e.channelId,
								title: d
							}),
						...
						l,
						c = "";
						s = r.indexOf('data-uix-load-more-href="/browse_ajax') + 25,
						l = r.indexOf('"', s),
						n.pages[e.page + 1] = {
							parseId: r.substring(s, l),
							cached: !1
						},
						a = r.slice(r.indexOf('id="channels-browse-content-grid"'), r.indexOf("browse-items-load-more-button")),
						n.pages[0] = {
							cached: !0,
							parseId: "   ",
							data: i(a, {
			...
			function i(e) {
				...
				for (c = e.split('<li class="yt-shelf-grid-item'), p = 0; p < c.length; p++)
					if (h = c[p], -1 !== h.indexOf("yt-lockup-content")) {
						if (-1 !== h.indexOf("yt-lockup-playlist"))
							f = "playlist";
						else {
							if (-1 === h.indexOf("yt-lockup-video") || -1 !== h.indexOf("branded-page-module") || -1 !== h.indexOf("data-set-reminder-text"))
								continue;
							f = "video",
							g = -1 !== h.indexOf("yt-badge-live")
						}
						u = h.indexOf("//i.ytimg"),
						d = h.indexOf('"', u),
						s = "https:" + h.substring(u, d).replace(/&amp;/g, "&"),
						u = h.indexOf(' data-ytid="') + 12,
						d = h.indexOf('"', u),
						l = h.substring(u, d),
						"playlist" === f && (u = h.indexOf('" dir="ltr">') + 12, d = h.indexOf("</a><span", u), a = h.substring(u, d), -1 !== h.indexOf('<div class="yt-lockup-byline ">YouTube</div>') && (l = ""), u = h.indexOf('<a href="/watch?v=') + 9, d = h.indexOf('"', u), m = h.substring(u, d).replace("&amp;", "&"), u = h.indexOf('" dir="ltr">') + 12, d = h.indexOf("<", u), n = h.substring(u, d), v.push({
								value: 1,
								playlistId: m,
								channel: {
			...
			r.prototype.getPage = function (e, t) {
				var n = this;
				e.page = +e.page || 0,
				this.pages[e.page] && this.pages[e.page].parseId ? this.pages[e.page].cached ? t(null, this.pages[e.page].data) : a("get", "https://www.youtube.com" + this.pages[e.page].parseId, function (r, o) {
					var a,
					s,
					l,
					c,
					...
					a.load_more_widget_html.trim().length > 10 ? (l = a.load_more_widget_html.indexOf('data-uix-load-more-href="') + 25, c = a.load_more_widget_html.indexOf('"', l), u = a.load_more_widget_html.substring(l, c)) : u = "",
					n.pages[e.page + 1] = {
						parseId: u,
						cached: !1
					},
					...
					s,
					l;
					s = r.indexOf('data-uix-load-more-href="') + 25,
					l = r.indexOf('"', s),
					n.pages[e.page + 1] = {
						parseId: r.substring(s, l),
						cached: !1
					},
					a = r.slice(r.indexOf('id="feed-main-'), r.indexOf('id="feed-error"')),
					n.pages[0] = {
						cached: !0,
						parseId: "   ",
						data: i(a)
			...
			function i(e) {
				...
				u,
				d = [];
				for (a = e.split('<li class="yt-uix-scroller-scroll-unit'), u = 0; u < a.length; u++)
					c = a[u], -1 !== c.indexOf('<div class="playlist-video-description">') && (s = c.indexOf('<span class="video-uploader-byline">') + 36, l = c.indexOf("</span>", s), c.substring(s, l).trim() && (s = c.indexOf('data-video-id="') + 15, l = c.indexOf('"', s), t = c.substring(s, l), s = c.indexOf('data-video-title="') + 18, l = c.indexOf('"', s), i = c.substring(s, l), s = c.indexOf('="https://i.ytimg') + 2, l = c.indexOf('"', s), r = c.substring(s, l).replace(/&amp;/g, "&"), s = c.indexOf(' data-ytid="UC') + 12, l = c.indexOf('"', s), o = c.substring(s, l), s = c.indexOf(">", s) + 1, l = c.indexOf("</", s), n = c.substring(s, l), d.push({
								value: 1,
								id: t,
								channelTitle: n,
								duration: " ",
			...
			r.prototype.getPage = function (e, t) {
				var n = this;
				return e.page = e.page || 0,
				e.playlistId ? e.page ? void t(null, []) : void(this.pages[0] ? t(null, this.pages[0].data) : a("get", "https://www.youtube.com" + e.playlistId, function (r, o) {
						var a,
						s,
						l;
						s = r.indexOf('id="playlist-autoscroll-list"'),
						l = r.indexOf('id="placeholder-player"', s),
						a = r.slice(s, l),
						n.pages[0] = {
							cached: !0,
			...
			function i(e) {
				...
				for (m = e.split('<div class="yt-lockup yt-lockup-tile '), g = 0; g < m.length; g++)
					if (v = m[g], -1 !== v.indexOf("yt-lockup-content")) {
						if (-1 !== v.indexOf("yt-lockup-playlist"))
							t = "playlist";
						else if (-1 !== v.indexOf("yt-lockup-channel"))
							t = "channel";
						else {
							if (-1 === v.indexOf("yt-lockup-video") || -1 !== v.indexOf("branded-page-module") || -1 !== v.indexOf("data-set-reminder-text"))
								continue;
							y = -1 !== v.indexOf("yt-badge-live"),
							t = "video"
						}
						p = v.indexOf("//i.ytimg"),
						f = v.indexOf('"', p),
						l = "https:" + v.substring(p, f).replace(/&amp;/g, "&"),
						p = v.indexOf('" dir="ltr">') + 12,
						11 === p && (p = v.indexOf(' dir="ltr">') + 11, 10 === p && (p = v.indexOf('" dir="rtl">') + 12)),
						f = v.indexOf("</", p),
						s = v.substring(p, f),
						p = v.indexOf(' data-ytid="') + 12,
						f = v.indexOf('"', p),
						c = v.substring(p, f),
						"playlist" === t && (-1 !== v.indexOf('<div class="yt-lockup-byline ">YouTube</div>') && (c = ""), p = v.indexOf('<a href="/watch?v=') + 9, f = v.indexOf('"', p), u = v.substring(p, f).replace("&amp;", "&"), p = v.indexOf('" dir="ltr">') + 12, f = v.indexOf("<", p), i = v.substring(p, f), b.push({
								value: 1,
								playlistId: u,
								channel: {
			...
			r.prototype.getPage = function (e, t) {
				...
				this.pages[e.page] && this.pages[e.page].parseId ? this.pages[e.page].cached ? t(null, this.pages[e.page].data) : a("get", "https://www.youtube.com" + this.pages[e.page].parseId, function (r, o) {
					...
					l,
					c;
					s = r.indexOf('class="branded-page-box search-pager'),
					l = r.indexOf('class="branded-page-v2-secondary-col', s),
					a = r.substring(s, l),
					a = a.split('<a href="'),
					a[a.length - 1] && -1 !== a[a.length - 1].indexOf("»") ? (s = a[a.length - 1].indexOf("/results?q="), l = a[a.length - 1].indexOf('"', s), c = a[a.length - 1].substring(s, l).replace("&amp;", "&")) : c = "",
					n.pages[e.page + 1] = {
						parseId: c,
						cached: !1
					},
					a = r.slice(r.indexOf('id="item-section-'), r.indexOf('class="branded-page-box search-pager')),
					n.pages[e.page] = {
						cached: !0,
						data: i(a)
					},
			...
			r.prototype.filter = function (e) {
				var t = !1;
				return void 0 !== e.searchQuery && this.searchQuery !== e.searchQuery && (t = !0, this.searchQuery = e.searchQuery),
				t ? (this.pages = {}, this.emit("content:changed", e), !0) : !1
			},
			e.exports = r
		}, function (e, t) {
			...
			function r(e, t) {
				...
				if (o)
					try {
						n = JSON.parse(stbWindowMgr.windowInfo(o)),
						-1 === n.result.url.indexOf(t) && stbWebWindow.messageSend(o, "window.load", t),
						e === d.BROWSER ? (o = stbWindowMgr.openWebFace(t), stbStorage.setItem(r, o)) : stbWindowMgr.windowShow(o)
					} catch (a) {
						stbWindowMgr.openWebFace(t)
					}
				else
					o = e === d.BROWSER ? stbWindowMgr.openWebFace(t) : stbWindowMgr.windowInit(JSON.stringify({
								url: t,
								backgroundColor: "#000"
			...
			u.addListener("show", function () {
				...
				n = setInterval(function () {
						...
						stbWindowMgr.resizeWebWindow(t.x, t.y, t.w, t.h),
						-1 !== l.indexOf("#") && -1 !== l.indexOf("code") && (l = l.split("?")[1].replace("#", "").split("&"), l.forEach(function (e) {
								r = e.split("="),
								u[r[0]] = r[1]
							}), u.code && (clearInterval(n), stbWebWindow.messageSend(e, "close"), c.postAuth(u.code).then(function (e) {
									o.settings.refreshToken = e.refreshToken,
									o.settings.sessionToken = e.sessionToken,
									o.settings.credentialsIndex = c.credentialsIndex,
									location.reload()
								}, function () {
									location.reload()
								})))
			...
			h.addListener("show", function (e) {
				...
				e.data && e.data.channel ? (o = r.activeTab, r.content.tabs[r.activeTab].hide(), r.activeTab = 1, r.content.tabs[r.activeTab].activate(e.data.channel)) : r.content.tabs.length > 0 && (o || (o = 3), r.content.tabs[r.activeTab].hide(), r.activeTab = o, r.content.tabs[r.activeTab].activate())
			}),
			...
			h.addListener("load", function () {
				...
				r.content.tabs.push(n(41)),
				r.content.tabs.push(n(42)),
				r.content.tabs.push(n(44)),
				r.content.tabs.push(n(43)),
				r.content.tabs.forEach(function (e) {
					h.add(e)
				}),
				r.content.tabs[r.activeTab].activate(),
				n(9).token ? n(30).getMine().then(function (e) {
			...
			"use strict";
			function i(e, t) {
				return e ? (window.ppVideoParseErrorMessage.innerHTML = gettext("11105 Video is not available"), o.hide(), l.show(), void(S = !1)) : (I.url = t.url, void s.play(t.url, {
			...
			p.addListener("load", function () {
				var e = [{
						...
						onclick: function () {
							s.playPause(),
							s.isPause ? (this.$icon.className = "icon player-play", this.$text.innerText = gettext("Play")) : (this.$icon.className = "icon player-pause", this.$text.innerText = gettext("Pause"))
						}
					}, {
						icon: "player-ff",
				...
				c = r.$body.children[3].button,
				a = n(45),
				a.addListener("show", function () {
					T.updateView({
						SEARCH: {
							icon: "search",
							visible: !0,
				...
				s.add(o),
				g.player = s,
				s.playContent = function (e) {
					var t;
					return window.playerChannelIcon.style.visibility = "hidden",
					window.playerChannelName.style.visibility = "hidden",
					S = !0,
					l.hide(),
					E.show(),
					window.ppPanelPlayer.classList.remove("transparent"),
					e.urlParseErrorCount || (e.urlParseErrorCount = 0),
					void 0 !== e.channel ? I.channel = e.channel : (t = e.video.channelId === I.channel.id ? I.channel.icon : !1, I.channel = {
								title: e.video.channelTitle,
								id: e.video.channelId,
								icon: t
							}),
					void 0 !== e.playlist && (I.playlist = e.playlist),
					void 0 !== e.position && (I.position = e.position),
					I.video = e.video,
					I.video.viewCount = I.video.viewCount.replace(/./g, ""),
					window.playerChannelName.innerText = I.channel.title,
					window.playerVideoName.innerHTML = I.video.title,
					window.playerVideoPublishedAt.innerText = gettext("Upload date") + ": " + I.video.publishedAt,
					window.playerVideoViewCount.innerText = ngettext("View", "Views", +I.video.viewCount) + ": " + I.video.viewCount,
					a.hide(),
					w.set(0),
					o.show(),
					T.show(),
					"" === e.video.duration ? (window.ppVideoParseErrorMessage.innerHTML = gettext("Live broadcasts are not supported"), o.hide(), l.show(), void(S = !1)) : void x.getInfo("https://www.youtube.com/watch?v=" + e.video.id, function (t, n) {
						var r,
						a,
						s;
						if (t)
							return "0:00" === e.video.duration ? window.ppVideoParseErrorMessage.innerHTML = gettext("Live broadcasts are not supported") : window.ppVideoParseErrorMessage.innerHTML = gettext("11442 Video is not available " + t), o.hide(), l.show(), void(S = !1);
						if (0 === n.formats.length)
							return "0:00" === e.video.duration ? window.ppVideoParseErrorMessage.innerHTML = gettext("Live broadcasts are not supported") : window.ppVideoParseErrorMessage.innerHTML = gettext("11445 Video is not available"), o.hide(), l.show(), void(S = !1);
						for (a = 0, s = n.formats.length; s > a; ++a)
							n.formats[a].resolution = n.formats[a].resolution || "", "mp4" === n.formats[a].container && n.formats[a].audioBitrate && (r ? r.resolution < n.formats[a].resolution && -1 !== n.formats[a].type.indexOf("video") && (r = n.formats[a]) : -1 !== n.formats[a].type.indexOf("video") && (r = n.formats[a]));
						r || (r = n.formats[0]),
						i(null, r)
					})
				},
				s.addListeners({
					pause: function (e) {
						e.state ? (c.$icon.className = "icon player-play", c.$text.innerText = gettext("Play")) : (c.$icon.className = "icon player-pause", c.$text.innerText = gettext("Pause")),
						e.state ? a.visible || o.display() : o.display(5)
					},
					duration: function (e) {
					...
					"playback:begin": function () {
						I.urlParseErrorCount = !1,
						window.ppPanelPlayer.classList.add("transparent"),
						E.hide(),
						window.playerTotalDuration.innerText = I.video.duration,
						w.init({
							value: 0,
							max: gSTB.GetMediaLen()
						}),
						I.channel.icon ? (window.playerChannelIcon.style.backgroundImage !== 'url("' + I.channel.icon + '")' && (window.playerChannelIcon.style.backgroundImage = 'url("' + I.channel.icon + '")'), window.playerChannelIcon.style.visibility = "", window.playerChannelName.style.visibility = "") : window.playerChannelIcon.style.backgroundImage = "none",
						c.$icon.className = "icon player-pause",
						c.$text.innerText = gettext("Pause"),
						S = !1,
						o.display(5),
						N || T.updateView({
							SEARCH: {
					...
					rewind: function (e) {
						...
						+t.hour && (n += t.hour + ":"),
						n += t.min + ":" + t.sec,
						window.playerCurrentDuration.innerText = n
					},
					"rewind:start": function () {
						w.$node.classList.add("rewind"),
						a.visible || o.display()
					},
					"rewind:apply": function () {
						w.$node.classList.remove("rewind"),
						o.display(6)
					},
					"position:input": function (e) {
						e.start && window.playerCurrentDuration.classList.add("setMode"),
						e.end && window.playerCurrentDuration.classList.remove("setMode"),
						w.set(e.sec),
						window.playerCurrentDuration.innerText = e.time
					},
					...
					"content:error": function () {
						I.urlParseErrorCount || (I.urlParseErrorCount = 0),
						I.urlParseErrorCount > 2 ? (window.ppVideoParseErrorMessage.innerHTML = gettext("11532 Video is not available"), l.show(), S = !1) : (++I.urlParseErrorCount, S = !1, s.playContent(I))
					}
				}),
				l = new y({
				...
				window.ppVideoParseErrorHeader.innerHTML = gettext("Error playing"),
				window.ppVideoParseErrorMessage.innerHTML = gettext("11554 Video is not available")
			}),
			...
			g.addListener("show", function () {
				...
				y.hide(),
				g.activeComponent || (b && (window.psSearchIcon.style.display = "block", setTimeout(function () {
			...
			function i(e) {
				...
				this.init(e),
				r.addListener("media", function (e) {
			...
			i.prototype.constructor = i,
			i.prototype.ASPECT_TYPE_FIT = 16,
			i.prototype.ASPECT_TYPE_BIG = 64,
			i.prototype.ASPECT_TYPE_OPTIMAL = 80,
			i.prototype.ASPECT_TYPE_ZOOM = 0,
			i.prototype.aspects = [{
					name: "fit",
			...
			i.prototype.STEREO_MODE_OFF = 0,
			i.prototype.STEREO_MODE_OVER_UNDER = 1,
			i.prototype.STEREO_MODE_OVER_UNDER_HD = 2,
			i.prototype.STEREO_MODE_SIDE_BY_SIDE = 3,
			i.prototype.stereoModes = [{
			...
			i.prototype.mediaListener = function (e) {
				...
				case r.EVENT_PLAYBACK_BEGIN:
					l.isPLaying = !0,
					l.durationInterval && (clearInterval(l.durationInterval), l.durationInterval = 0),
					l.durationInterval = setInterval(function () {
					...
					l.events["playback:begin"] && l.emit("playback:begin");
					break;
				case r.EVENT_GET_MEDIA_INFO:
					l.totalDurationSec = gSTB.GetMediaLen(),
					l.totalDurationSec > 3600 ? l.setModeHelper.length = 6 : l.setModeHelper.length = 4,
					t = l.parseTime(gSTB.GetMediaLen()),
					l.totalDuration = (t.hour > 0 ? t.hour + ":" : "") + t.min + ":" + t.sec,
					c.totalDuration = l.totalDuration,
					c.totalDurationSec = l.totalDurationSec;
					try {
						a = gSTB.GetAudioPIDs().replace(/pid:/g, '"pid":').replace(/lang:/g, '"lang":'),
						l.audioPIDs = JSON.parse(a)
					} catch (u) {}
					try {
						s = gSTB.GetSubtitlePIDs().replace(/pid:/g, '"pid":').replace(/lang:/g, '"lang":'),
						l.subtitlePIDs = JSON.parse(s)
					} catch (u) {}
					l.currentAudioPID = 0,
					"" !== l.audioPIDs[0].lang[0] ? c.audioPid = l.audioPIDs[0].lang[0] : c.audioPid = void 0,
					l.currentSubtitle = null,
					c.subtitles = null,
					c.stereoMode = {
				...
				case r.EVENT_CONTENT_ERROR:
					l.isPLaying = !1,
					l.events["content:error"] && l.emit("content:error");
					break;
				case r.EVENT_END_OF_FILE:
					l.currentSec = l.totalDurationSec,
					l.isPLaying = !1,
					l.events["content:end"] && l.emit("content:end");
					break;
				case r.EVENT_SUBTITLE_LOAD_ERROR:
					l.subtitlePIDs.pop();
					break;
				case r.EVENT_HDMI_DISCONNECT:
					if (i = parseInt(JSON.parse(gSTB.GetEnv('{"varList":["hdmi_event_delay"]}')).result.hdmi_event_delay, 10), 0 === i)
						return;
					l.hdmiEventTimeout = setTimeout(function () {
							...
							gSTB.StandBy(!0),
							l.hdmiEventTimeout = null
						}, i);
					break;
				case r.EVENT_HDMI_CONNECT:
					if (i = parseInt(JSON.parse(gSTB.GetEnv('{"varList":["hdmi_event_delay"]}')).result.hdmi_event_delay, 10), 0 === i)
						return;
					if (l.hdmiEventTimeout)
						return clearTimeout(l.hdmiEventTimeout), void(l.hdmiEventTimeout = null);
					gSTB.StandBy(!1),
					o = JSON.parse(stbStorage.getItem("standByPlayback")),
					i && (l.play(o.url, {
							position: o.position
			...
			i.prototype.init = function (e) {
				e.allowInputPosition && (this.allowInputPosition = e.allowInputPosition),
				e.rewindDuration && (this.rewindHelper.duration = e.rewindDuration),
				e.rewindTimeout && (this.rewindHelper.timeoutDuration = e.rewindTimeout),
				e.inputPositionTimeout && (this.setModeHelper.timeoutDuration = e.inputPositionTimeout),
				gSTB.InitPlayer(),
				gSTB.SetAspect(16),
			...
			i.prototype.play = function (e, t) {
				...
				this.playUrl = e,
				t = t || {},
				n = t.solution ? t.solution : "auto",
				i = t.position ? " position:" + t.position : "",
				gSTB.Play(n + " " + e + i, t.proxy)
			},
			...
			i.prototype.playPause = function () {
				...
				this.events.pause && this.emit("pause", {
					state: this.isPause
				})
			},
			i.prototype.rewind = function (e, t) {
				...
				this.rewindHelper.isActive || (this.currentSec = gSTB.GetPosTime(), n = i.parseTime(i.currentSec), this.currentTime = (n.hour > 0 ? n.hour + ":" : "") + n.min + ":" + n.sec, this.rewindHelper.isActive = !0, this.rewindHelper.startTime = this.currentSec, this.rewindHelper.time = this.currentSec, this.events["rewind:start"] && this.emit("rewind:start")),
				e ? this.rewindHelper.time + t < this.totalDurationSec ? this.rewindHelper.time += t : this.rewindHelper.time = this.totalDurationSec : this.rewindHelper.time - t > 0 ? this.rewindHelper.time -= t : this.rewindHelper.time = 0,
				this.rewindHelper.timeout && clearTimeout(this.rewindHelper.timeout),
				this.events.rewind && this.emit("rewind", {
				...
				this.rewindHelper.timeoutDuration ? this.rewindHelper.timeout = setTimeout(function () {
						return clearInterval(i.durationInterval),
						i.durationInterval = 0,
						i.rewindHelper.isActive = !1,
						i.events["rewind:apply"] && i.emit("rewind:apply"),
						i.currentSec = i.rewindHelper.time,
						i.rewindHelper.timeout = 0,
						i.rewindHelper.time === i.totalDurationSec ? void(i.events["content:end"] && i.emit("content:end")) : void gSTB.SetPosTime(i.rewindHelper.time)
			...
			i.prototype.setAudioTrack = function (e) {
				...
				this.events["audio:track"] && this.emit("audio:track", {
					lang: this.audioPIDs[this.currentAudioPID].lang[0],
					pid: this.audioPIDs[this.currentAudioPID].pid
				})
			},
			i.prototype.nextAspect = function () {
				this.activeAspect++,
				this.activeAspect > this.aspects.length - 1 && (this.activeAspect = 0),
				gSTB.SetAspect(this.aspects[this.activeAspect].mode),
				this.events["aspect:change"] && this.emit("aspect:change", {
			...
			i.prototype.setSubtitle = function (e) {
				...
				this.events["subtitles:change"] && this.emit("subtitles:change", {
					lang: this.subtitlePIDs[this.currentSubtitle].lang[0],
					pid: this.subtitlePIDs[this.currentSubtitle].pid
				})
			},
			i.prototype.hideSubtitles = function () {
				gSTB.SetSubtitles(!1),
				this.events["subtitles:change"] && this.emit("subtitles:change", null)
			},
			...
			i.prototype.nextViewMode = function () {
				...
				this.events["viewmode:change"] && this.emit("viewmode:change", {
			...
			i.prototype.inputPosition = function (e) {
				...
				this.allowInputPosition && (this.setModeHelper.active || (6 === this.setModeHelper.length ? this.setModeHelper.time = [0, 0, 0, 0, 0, 0] : this.setModeHelper.time = [0, 0, 0, 0], this.setModeHelper.count = 0, this.setModeHelper.active = !0, 6 === this.setModeHelper.length ? this.events["position:input"] && this.emit("position:input", {
							...
							a.setModeHelper.active = !1,
							clearInterval(a.durationInterval),
							a.durationInterval = 0,
							gSTB.SetPosTime(a.setModeHelper.sec),
							a.currentSec = a.setModeHelper.sec,
							n = a.parseTime(a.currentSec),
							a.currentTime = (n.hour > 0 ? n.hour + ":" : "") + n.min + ":" + n.sec,
							a.events["position:input"] && a.emit("position:input", {
								time: a.setModeHelper.timeStr,
			...
			i.prototype.setPosition = function (e) {
				...
				gSTB.SetPosTime(e),
				this.currentSec = e,
				t = self.parseTime(self.currentSec),
				this.currentTime = (t.hour > 0 ? t.hour + ":" : "") + t.min + ":" + t.sec,
				this.events["position:set"] && this.emit("position:set", {
					sec: e
				})
			},
			...
			i.prototype.addListener = function (e, t) {
				var n;
				a.prototype.addListener.call(this, e, t),
				"duration" === e && (this.currentSec = gSTB.GetPosTime(), n = this.parseTime(this.currentSec), this.currentTime = (n.hour > 0 ? n.hour + ":" : "") + n.min + ":" + n.sec, this.emit("duration", {
						sec: this.currentSec,
			...
			if (!("classList" in document.documentElement)) {
				...
				window.DOMTokenList = function (e) {
					if (this._element = e, e.className !== this._classCache) {
						if (this._classCache = e.className, !this._classCache)
							return;
						var t,
						n = this._classCache.replace(/^\s+|\s+$/g, "").split(/\s+/);
				...
				window.DOMTokenList.prototype = {
					...
					remove: function (e) {
						var t = i.call(this, e);
						-1 !== t && (a.call(this, t, 1), this._element.className = r.call(this, 0).join(" "))
					},
					toString: function () {
						return s.call(this, " ")
					},
			...
			function i(e) {
				...
				r.call(this, e),
				e.icon && (this.$icon = this.$body.appendChild(document.createElement("div")), this.$icon.className = "icon " + e.icon),
			...
			function r(e) {
				...
				for (t = 0; t < e.length; t++)
					for (n = 0; n < e[t].length; n++)
						i = e[t][n], "object" != typeof i ? i = e[t][n] = {
							value: e[t][n],
							colSpan: 1,
							rowSpan: 1
						}
			...
			function o(e, t, n, i, r, o) {
				...
				s;
				for (a = n; n + r > a; a++) {
					for (e.length < a + 1 && e.push([]); void 0 !== e[a][t]; )
						t++;
					for (s = t; t + i > s; s++)
						e[a].length < s + 1 && e[a].push(), e[a][s] = o, void 0 === o.x && (o.x = s), void 0 === o.y && (o.y = a)
				}
			}
			function a(e) {
				var t,
				...
				for (t = 0; t < e.length; t++)
					for (n = 0; n < e[t].length; n++)
						i = e[t][n], o(r, n, t, i.colSpan, i.rowSpan, i.$item), delete i.$item;
				return r
			}
			var s = n(4),
			l = n(1);
			...
			i.prototype.defaultEvents = {
				mousewheel: function (e) {
					e.wheelDeltaY && this.move(e.wheelDeltaY > 0 ? l.up : l.down),
					e.wheelDeltaX && this.move(e.wheelDeltaX > 0 ? l.left : l.right)
				},
				keydown: function (e) {
					switch (e.code) {
					case l.up:
				...
				f = function (u) {
					if (u && d.data !== u && (d.data = u, h = !0), e.render && d.renderItem !== e.render && (d.renderItem = e.render, h = !0), h) {
						for (d.$table = document.createElement("table"), s = document.createElement("tbody"), d.data = r(d.data), t = 0; t < d.data.length; t++) {
							for (i = s.insertRow(), n = 0; n < d.data[t].length; n++)
								o = i.insertCell(-1), o.className = "item", c = d.data[t][n], c.$item = o, o.colSpan = c.colSpan, o.rowSpan = c.rowSpan, c.focus && (l = o), c.disable && o.classList.add("disable"), c.mark && o.classList.add("mark"), d.renderItem(o, c), o.data = c, o.addEventListener("click", p);
							s.appendChild(i)
						}
						d.map = a(d.data),
						d.$body.innerText = null,
						d.$table.appendChild(s),
						d.$body.appendChild(d.$table),
						l ? d.focusItem(l) : d.focusItem(d.map[0][0])
					}
				};
				void 0 !== e.cycleX && (this.cycleX = e.cycleX),
				void 0 !== e.cycleY && (this.cycleY = e.cycleY),
				e.provider && (this.provider = e.provider, this.sizeX = e.sizeX, this.sizeY = e.sizeY),
				e.translate && (this.translate = e.translate),
				e.provider ? (u = this.provider.get(null, function (e, t) {
							e && d.events["data:error"] && d.emit("data:error", e),
							f(d.translate(t)),
							d.events["data:ready"] && d.emit("data:ready")
			...
			i.prototype.defaultTranslate = function (e) {
				...
				for (t = 0; t < this.sizeY; t++) {
					for (i = [], n = 0; n < this.sizeX; n++)
						i[n] = e[t * this.sizeX + n];
					r[t] = i
				}
				return r
			},
			i.prototype.translate = i.prototype.defaultTranslate,
			i.prototype.move = function (e) {
				for (var t, n, i, r = this.focusX, o = this.focusY, a = !0, s = !1, c = !1; a; ) {
					...
					r === this.focusX && o === this.focusY && (a = !1),
					this.map[o][r] !== this.map[this.focusY][this.focusX] && this.map[o][r].data.disable !== !0 && (a = !1),
					s && (a = !1, this.map[o][r].data.disable === !0 && (r = this.focusX, o = this.focusY))
				}
				this.focusItem(this.map[o][r]),
				this.focusX = r,
				this.focusY = o,
				s && (this.provider && (t = this.provider.get(e, function (e, t) {
								if (e && self.events["data:error"])
									return self.emit("data:error", e), !1;
								if (t) {
									for (self.data = self.translate(t), n = 0; n < self.sizeY - 1; n++)
										for (i = 0; i < self.sizeX; i++)
											self.renderItem(self.map[n][i], self.data[n][i]);
			...
			function i(e) {
				e = e || {},
				e.className = "modalBox " + (e.className || ""),
				e.$body = document.createElement("div"),
				e.$body.className = "body",
				r.call(this, e),
