...
class SysEvent extends Event
{
    ...
    /**
     * Send "diagnostic page" event
     */
    public function sendDiagnosticPage(){
        $this->setEvent('diagnostic_page');
        $this->send();
    }

    /**
     * Send "set variable" event
     */
    public function sendSetVariable($msg){
        $this->setEvent('set_variable');
        $this->setMsg($msg);
        $this->send();
    }

    /**
     * Send "set volume in stalker" event
     */
    public function sendSetVolume($e_vol){
        $this->setEvent('set_volume');
        $this->setMsg($e_vol);
        $this->send();
    }
